...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 df 7a 10 80 	movl   $0x80107adf,(%esp)
...
8010042a:	e8 21 59 00 00       	call   80105d50 <uartputc>
...
80100515:	e8 36 58 00 00       	call   80105d50 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 2a 58 00 00       	call   80105d50 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 1e 58 00 00       	call   80105d50 <uartputc>
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 af 63 00 00       	call   80106ec0 <setupkvm>
...
80100b73:	e8 68 61 00 00       	call   80106ce0 <allocuvm>
...
80100ba9:	e8 62 60 00 00       	call   80106c10 <loaduvm>
...
80100beb:	e8 50 62 00 00       	call   80106e40 <freevm>
  if(ip){
...
80100c32:	e8 a9 60 00 00       	call   80106ce0 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 08 63 00 00       	call   80106f60 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100ce1:	e8 5a 61 00 00       	call   80106e40 <freevm>
...
80100d9d:	e8 de 5c 00 00       	call   80106a80 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 96 60 00 00       	call   80106e40 <freevm>
  return 0;
...
80102020:	68 c6 78 10 80       	push   $0x801078c6
...
80103002:	e8 89 29 00 00       	call   80105990 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 31 3a 00 00       	call   80106a60 <switchkvm>
  seginit();
...
80103065:	e8 d6 3e 00 00       	call   80106f40 <kvmalloc>
...
80103088:	e8 03 2c 00 00       	call   80105c90 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 79 28 00 00       	call   80105910 <tvinit>
  binit();         // buffer cache
...
801037dc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e2:	e8 99 0e 00 00       	call   80104680 <release>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 01 59 10 80 	movl   $0x80105901,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 b5 0e 00 00       	call   801046d0 <memset>
...
8010383a:	e8 41 0e 00 00       	call   80104680 <release>
}
...
8010386f:	e8 0c 0e 00 00       	call   80104680 <release>
...
801038c4:	e8 77 0b 00 00       	call   80104440 <initlock>
}
...
8010392d:	68 a4 77 10 80       	push   $0x801077a4
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 50 0b 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 90 0b 00 00       	call   80104510 <popcli>
}
...
801039a7:	e8 14 35 00 00       	call   80106ec0 <setupkvm>
...
801039c5:	e8 c6 31 00 00       	call   80106b90 <inituvm>
...
801039da:	e8 f1 0c 00 00       	call   801046d0 <memset>
...
80103a39:	e8 52 0e 00 00       	call   80104890 <safestrcpy>
  p->cwd = namei("/");
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 1f 0a 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 5f 0a 00 00       	call   80104510 <popcli>
  sz = curproc->sz;
...
80103abf:	e8 bc 2f 00 00       	call   80106a80 <switchuvm>
  return 0;
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 9e 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 de 09 00 00       	call   80104510 <popcli>
  if((np = allocproc()) == 0){
...
80103b4c:	e8 3f 34 00 00       	call   80106f90 <copyuvm>
...
80103c66:	e8 55 09 00 00       	call   801045c0 <acquire>
...
80103c80:	e8 fb 2d 00 00       	call   80106a80 <switchuvm>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 5c 0c 00 00       	call   801048f3 <swtch>
      switchkvm();
...
80103cbc:	e8 bf 09 00 00       	call   80104680 <release>
    sti();
...
80103ce3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ce9:	e8 22 08 00 00       	call   80104510 <popcli>
  if(!holding(&ptable.lock))
80103cee:	83 ec 0c             	sub    $0xc,%esp
80103cf1:	68 20 2d 11 80       	push   $0x80112d20
80103cf6:	e8 75 08 00 00       	call   80104570 <holding>
...
80103d37:	e8 b7 0b 00 00       	call   801048f3 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 1e 07 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 5e 07 00 00       	call   80104510 <popcli>
  if(curproc == initproc)
...
80103e0a:	e8 b1 07 00 00       	call   801045c0 <acquire>
...
80103ee0:	e8 db 06 00 00       	call   801045c0 <acquire>
  pushcli();
80103ee5:	e8 d6 05 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 16 06 00 00       	call   80104510 <popcli>
...
80103f0d:	e8 6e 07 00 00       	call   80104680 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 88 05 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 c8 05 00 00       	call   80104510 <popcli>
  if(p == 0)
...
80103f64:	e8 57 06 00 00       	call   801045c0 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 0f 07 00 00       	call   80104680 <release>
  p->chan = chan;
...
80103f8e:	e8 ed 06 00 00       	call   80104680 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 1b 06 00 00       	jmp    801045c0 <acquire>
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 ba 2d 00 00       	call   80106e40 <freevm>
        release(&ptable.lock);
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 ce 05 00 00       	call   80104680 <release>
        return pid;
...
801040cb:	e8 b0 05 00 00       	call   80104680 <release>
      return -1;
...
801040f3:	e8 c8 04 00 00       	call   801045c0 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 42 05 00 00       	jmp    80104680 <release>
...
80104193:	e8 e8 04 00 00       	call   80104680 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041b0:	e8 cb 04 00 00       	call   80104680 <release>
}
...
801041f3:	68 df 7a 10 80       	push   $0x80107adf
...
80104220:	8b 14 85 cc 77 10 80 	mov    -0x7fef8834(,%eax,4),%edx
      state = "???";
...
8010425d:	e8 fe 01 00 00       	call   80104460 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a7:	83 ec 14             	sub    $0x14,%esp
    cprintf("hello Hadi\n");
801042aa:	68 58 77 10 80       	push   $0x80107758
...
801042d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p->state == UNUSED) 
        procCount++;
801042d8:	83 78 0c 01          	cmpl   $0x1,0xc(%eax)
801042dc:	83 d3 00             	adc    $0x0,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042df:	83 c0 7c             	add    $0x7c,%eax
801042e2:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
801042e7:	75 ef                	jne    801042d8 <getProcCount+0x18>
  }

  cprintf("procCount is : %d\n",procCount);
801042e9:	83 ec 08             	sub    $0x8,%esp
801042ec:	53                   	push   %ebx
801042ed:	68 64 77 10 80       	push   $0x80107764
...
8010430e:	68 e4 77 10 80       	push   $0x801077e4
...
8010436d:	e8 ae fb ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
...
8010437b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104381:	e8 da f5 ff ff       	call   80103960 <myproc>
...
801043c8:	e8 13 fd ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
8010453f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104540:	e8 8b f3 ff ff       	call   801038d0 <mycpu>
...
80104555:	68 ef 77 10 80       	push   $0x801077ef
8010455a:	e8 31 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 06 78 10 80       	push   $0x80107806
...
8010459b:	e8 30 f3 ff ff       	call   801038d0 <mycpu>
...
80104667:	68 0d 78 10 80       	push   $0x8010780d
...
801046c0:	68 15 78 10 80       	push   $0x80107815
...
8010491b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010491e:	e8 3d f0 ff ff       	call   80103960 <myproc>
...
8010495b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010495e:	e8 fd ef ff ff       	call   80103960 <myproc>
...
801049b9:	e8 a2 ef ff ff       	call   80103960 <myproc>
...
801049c7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049ca:	e8 91 ef ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a0c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a0f:	e8 4c ef ff ff       	call   80103960 <myproc>
...
80104aa8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104aab:	e8 b0 ee ff ff       	call   80103960 <myproc>
...
80104abb:	83 fa 16             	cmp    $0x16,%edx
80104abe:	77 20                	ja     80104ae0 <syscall+0x40>
80104ac0:	8b 14 85 40 78 10 80 	mov    -0x7fef87c0(,%eax,4),%edx
...
80104ae8:	68 1d 78 10 80       	push   $0x8010781d
...
80104c44:	68 bc 78 10 80       	push   $0x801078bc
...
80104c5c:	68 bb 78 10 80       	push   $0x801078bb
...
80104c71:	68 af 78 10 80       	push   $0x801078af
...
80104c8f:	68 be 78 10 80       	push   $0x801078be
80104c94:	e8 f7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c99:	83 ec 0c             	sub    $0xc,%esp
80104c9c:	68 a0 78 10 80       	push   $0x801078a0
...
80104cd4:	e8 87 ec ff ff       	call   80103960 <myproc>
...
80104e67:	78 27                	js     80104e90 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e69:	e8 f2 ea ff ff       	call   80103960 <myproc>
...
8010508d:	58                   	pop    %eax
8010508e:	5a                   	pop    %edx
8010508f:	68 bc 78 10 80       	push   $0x801078bc
...
801050a8:	68 bb 78 10 80       	push   $0x801078bb
...
80105297:	74 23                	je     801052bc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105299:	e8 c2 e6 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105479:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
8010547c:	e8 df e4 ff ff       	call   80103960 <myproc>
...
8010565b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010565d:	e8 fe e2 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105700:	f3 0f 1e fb          	endbr32 
  return fork();
80105704:	e9 07 e4 ff ff       	jmp    80103b10 <fork>
...
80105717:	83 ec 08             	sub    $0x8,%esp
  exit();
8010571a:	e8 71 e6 ff ff       	call   80103d90 <exit>
...
80105730:	f3 0f 1e fb          	endbr32 
  return wait();
80105734:	e9 a7 e8 ff ff       	jmp    80103fe0 <wait>
...
80105762:	e8 d9 e9 ff ff       	call   80104140 <kill>
...
80105787:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
8010578a:	e8 d1 e1 ff ff       	call   80103960 <myproc>
...
801057bb:	78 23                	js     801057e0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057bd:	e8 9e e1 ff ff       	call   80103960 <myproc>
  if(growproc(n) < 0)
...
801057ca:	e8 c1 e2 ff ff       	call   80103a90 <growproc>
...
80105814:	68 60 4c 11 80       	push   $0x80114c60
80105819:	e8 a2 ed ff ff       	call   801045c0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010581e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105821:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105833:	68 60 4c 11 80       	push   $0x80114c60
80105838:	68 a0 54 11 80       	push   $0x801154a0
8010583d:	e8 de e6 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105842:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
8010584f:	73 2f                	jae    80105880 <sys_sleep+0x90>
    if(myproc()->killed){
80105851:	e8 0a e1 ff ff       	call   80103960 <myproc>
...
80105860:	68 60 4c 11 80       	push   $0x80114c60
...
80105883:	68 60 4c 11 80       	push   $0x80114c60
...
801058a8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058ab:	68 60 4c 11 80       	push   $0x80114c60
801058b0:	e8 0b ed ff ff       	call   801045c0 <acquire>
  xticks = ticks;
801058b5:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801058bb:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
801058d0:	f3 0f 1e fb          	endbr32 
  return getHello();
801058d4:	e9 c7 e9 ff ff       	jmp    801042a0 <getHello>
801058d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

801058e0 <sys_getProcCount>:
}
...
801058e0:	f3 0f 1e fb          	endbr32 
  return getProcCount();
801058e4:	e9 d7 e9 ff ff       	jmp    801042c0 <getProcCount>
...
801058f8:	54                   	push   %esp
  call trap
801058f9:	e8 c2 00 00 00       	call   801059c0 <trap>
  addl $4, %esp
...
80105927:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
8010592e:	08 00 00 8e 
80105932:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105939:	80 
8010593a:	c1 ea 10             	shr    $0x10,%edx
8010593d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105944:	80 
  for(i = 0; i < 256; i++)
...
80105957:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
8010595e:	00 00 ef 
  initlock(&tickslock, "time");
80105961:	68 01 79 10 80       	push   $0x80107901
80105966:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010596b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105971:	c1 e8 10             	shr    $0x10,%eax
80105974:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
8010597a:	e8 c1 ea ff ff       	call   80104440 <initlock>
}
...
80105994:	55                   	push   %ebp
  pd[0] = size-1;
80105995:	b8 ff 07 00 00       	mov    $0x7ff,%eax
8010599a:	89 e5                	mov    %esp,%ebp
8010599c:	83 ec 10             	sub    $0x10,%esp
8010599f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059a3:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
801059a8:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
801059ac:	c1 e8 10             	shr    $0x10,%eax
801059af:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
801059b3:	8d 45 fa             	lea    -0x6(%ebp),%eax
801059b6:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
801059b9:	c9                   	leave  
801059ba:	c3                   	ret    
...
801059ca:	83 ec 1c             	sub    $0x1c,%esp
801059cd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
801059d0:	8b 43 30             	mov    0x30(%ebx),%eax
801059d3:	83 f8 40             	cmp    $0x40,%eax
801059d6:	0f 84 bc 01 00 00    	je     80105b98 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
801059dc:	83 e8 20             	sub    $0x20,%eax
801059df:	83 f8 1f             	cmp    $0x1f,%eax
801059e2:	77 08                	ja     801059ec <trap+0x2c>
801059e4:	3e ff 24 85 a8 79 10 	notrack jmp *-0x7fef8658(,%eax,4)
801059eb:	80 
    lapiceoi();
    break;
...
801059ec:	e8 6f df ff ff       	call   80103960 <myproc>
801059f1:	8b 7b 38             	mov    0x38(%ebx),%edi
801059f4:	85 c0                	test   %eax,%eax
801059f6:	0f 84 eb 01 00 00    	je     80105be7 <trap+0x227>
801059fc:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a00:	0f 84 e1 01 00 00    	je     80105be7 <trap+0x227>
...
80105a06:	0f 20 d1             	mov    %cr2,%ecx
80105a09:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105a0c:	e8 2f df ff ff       	call   80103940 <cpuid>
80105a11:	8b 73 30             	mov    0x30(%ebx),%esi
80105a14:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105a17:	8b 43 34             	mov    0x34(%ebx),%eax
80105a1a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105a1d:	e8 3e df ff ff       	call   80103960 <myproc>
80105a22:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105a25:	e8 36 df ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a2a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105a2d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105a30:	51                   	push   %ecx
80105a31:	57                   	push   %edi
80105a32:	52                   	push   %edx
80105a33:	ff 75 e4             	pushl  -0x1c(%ebp)
80105a36:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105a37:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105a3a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a3d:	56                   	push   %esi
80105a3e:	ff 70 10             	pushl  0x10(%eax)
80105a41:	68 64 79 10 80       	push   $0x80107964
80105a46:	e8 65 ac ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105a4b:	83 c4 20             	add    $0x20,%esp
80105a4e:	e8 0d df ff ff       	call   80103960 <myproc>
80105a53:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105a5a:	e8 01 df ff ff       	call   80103960 <myproc>
80105a5f:	85 c0                	test   %eax,%eax
80105a61:	74 1d                	je     80105a80 <trap+0xc0>
80105a63:	e8 f8 de ff ff       	call   80103960 <myproc>
80105a68:	8b 50 24             	mov    0x24(%eax),%edx
80105a6b:	85 d2                	test   %edx,%edx
80105a6d:	74 11                	je     80105a80 <trap+0xc0>
80105a6f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a73:	83 e0 03             	and    $0x3,%eax
80105a76:	66 83 f8 03          	cmp    $0x3,%ax
80105a7a:	0f 84 50 01 00 00    	je     80105bd0 <trap+0x210>
    exit();
...
80105a87:	74 0f                	je     80105a98 <trap+0xd8>
80105a89:	e8 d2 de ff ff       	call   80103960 <myproc>
80105a8e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a92:	0f 84 e8 00 00 00    	je     80105b80 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a98:	e8 c3 de ff ff       	call   80103960 <myproc>
...
80105ab8:	0f 84 03 01 00 00    	je     80105bc1 <trap+0x201>
    exit();
}
...
80105ac5:	c3                   	ret    
    ideintr();
80105ac6:	e8 15 c7 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105acb:	e8 f0 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ad0:	e8 8b de ff ff       	call   80103960 <myproc>
80105ad5:	85 c0                	test   %eax,%eax
80105ad7:	75 8a                	jne    80105a63 <trap+0xa3>
80105ad9:	eb a5                	jmp    80105a80 <trap+0xc0>
    if(cpuid() == 0){
80105adb:	e8 60 de ff ff       	call   80103940 <cpuid>
80105ae0:	85 c0                	test   %eax,%eax
80105ae2:	75 e7                	jne    80105acb <trap+0x10b>
      acquire(&tickslock);
80105ae4:	83 ec 0c             	sub    $0xc,%esp
80105ae7:	68 60 4c 11 80       	push   $0x80114c60
80105aec:	e8 cf ea ff ff       	call   801045c0 <acquire>
      wakeup(&ticks);
80105af1:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105af8:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105aff:	e8 dc e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b04:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105b0b:	e8 70 eb ff ff       	call   80104680 <release>
80105b10:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105b13:	eb b6                	jmp    80105acb <trap+0x10b>
    kbdintr();
80105b15:	e8 66 cc ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105b1a:	e8 a1 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b1f:	e8 3c de ff ff       	call   80103960 <myproc>
80105b24:	85 c0                	test   %eax,%eax
80105b26:	0f 85 37 ff ff ff    	jne    80105a63 <trap+0xa3>
80105b2c:	e9 4f ff ff ff       	jmp    80105a80 <trap+0xc0>
    uartintr();
80105b31:	e8 4a 02 00 00       	call   80105d80 <uartintr>
    lapiceoi();
80105b36:	e8 85 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b3b:	e8 20 de ff ff       	call   80103960 <myproc>
80105b40:	85 c0                	test   %eax,%eax
80105b42:	0f 85 1b ff ff ff    	jne    80105a63 <trap+0xa3>
80105b48:	e9 33 ff ff ff       	jmp    80105a80 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b4d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b50:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105b54:	e8 e7 dd ff ff       	call   80103940 <cpuid>
80105b59:	57                   	push   %edi
80105b5a:	56                   	push   %esi
80105b5b:	50                   	push   %eax
80105b5c:	68 0c 79 10 80       	push   $0x8010790c
80105b61:	e8 4a ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105b66:	e8 55 cd ff ff       	call   801028c0 <lapiceoi>
    break;
80105b6b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6e:	e8 ed dd ff ff       	call   80103960 <myproc>
80105b73:	85 c0                	test   %eax,%eax
80105b75:	0f 85 e8 fe ff ff    	jne    80105a63 <trap+0xa3>
80105b7b:	e9 00 ff ff ff       	jmp    80105a80 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105b80:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105b84:	0f 85 0e ff ff ff    	jne    80105a98 <trap+0xd8>
    yield();
80105b8a:	e8 41 e3 ff ff       	call   80103ed0 <yield>
80105b8f:	e9 04 ff ff ff       	jmp    80105a98 <trap+0xd8>
80105b94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105b98:	e8 c3 dd ff ff       	call   80103960 <myproc>
80105b9d:	8b 70 24             	mov    0x24(%eax),%esi
80105ba0:	85 f6                	test   %esi,%esi
80105ba2:	75 3c                	jne    80105be0 <trap+0x220>
    myproc()->tf = tf;
80105ba4:	e8 b7 dd ff ff       	call   80103960 <myproc>
80105ba9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bac:	e8 ef ee ff ff       	call   80104aa0 <syscall>
    if(myproc()->killed)
80105bb1:	e8 aa dd ff ff       	call   80103960 <myproc>
80105bb6:	8b 48 24             	mov    0x24(%eax),%ecx
80105bb9:	85 c9                	test   %ecx,%ecx
80105bbb:	0f 84 fd fe ff ff    	je     80105abe <trap+0xfe>
}
...
80105bc7:	5d                   	pop    %ebp
      exit();
80105bc8:	e9 c3 e1 ff ff       	jmp    80103d90 <exit>
80105bcd:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105bd0:	e8 bb e1 ff ff       	call   80103d90 <exit>
80105bd5:	e9 a6 fe ff ff       	jmp    80105a80 <trap+0xc0>
...
80105be7:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105bea:	e8 51 dd ff ff       	call   80103940 <cpuid>
...
80105bf8:	68 30 79 10 80       	push   $0x80107930
80105bfd:	e8 ae aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c02:	83 c4 14             	add    $0x14,%esp
80105c05:	68 06 79 10 80       	push   $0x80107906
80105c0a:	e8 81 a7 ff ff       	call   80100390 <panic>
80105c0f:	90                   	nop
...
80105c10:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105c14:	a1 bc a5 10 80       	mov    0x8010a5bc,%eax
80105c19:	85 c0                	test   %eax,%eax
80105c1b:	74 1b                	je     80105c38 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105c1d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105c22:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105c23:	a8 01                	test   $0x1,%al
80105c25:	74 11                	je     80105c38 <uartgetc+0x28>
80105c27:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105c2c:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105c2d:	0f b6 c0             	movzbl %al,%eax
80105c30:	c3                   	ret    
...
80105c65:	e8 76 cc ff ff       	call   801028e0 <microdelay>
...
80105c95:	31 c9                	xor    %ecx,%ecx
80105c97:	89 c8                	mov    %ecx,%eax
80105c99:	89 e5                	mov    %esp,%ebp
80105c9b:	57                   	push   %edi
80105c9c:	56                   	push   %esi
80105c9d:	53                   	push   %ebx
80105c9e:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105ca3:	89 da                	mov    %ebx,%edx
80105ca5:	83 ec 0c             	sub    $0xc,%esp
80105ca8:	ee                   	out    %al,(%dx)
80105ca9:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105cae:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105cb3:	89 fa                	mov    %edi,%edx
80105cb5:	ee                   	out    %al,(%dx)
80105cb6:	b8 0c 00 00 00       	mov    $0xc,%eax
80105cbb:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105cc0:	ee                   	out    %al,(%dx)
80105cc1:	be f9 03 00 00       	mov    $0x3f9,%esi
80105cc6:	89 c8                	mov    %ecx,%eax
80105cc8:	89 f2                	mov    %esi,%edx
80105cca:	ee                   	out    %al,(%dx)
80105ccb:	b8 03 00 00 00       	mov    $0x3,%eax
80105cd0:	89 fa                	mov    %edi,%edx
80105cd2:	ee                   	out    %al,(%dx)
80105cd3:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105cd8:	89 c8                	mov    %ecx,%eax
80105cda:	ee                   	out    %al,(%dx)
80105cdb:	b8 01 00 00 00       	mov    $0x1,%eax
80105ce0:	89 f2                	mov    %esi,%edx
80105ce2:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105ce3:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105ce8:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105ce9:	3c ff                	cmp    $0xff,%al
80105ceb:	74 52                	je     80105d3f <uartinit+0xaf>
  uart = 1;
80105ced:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105cf4:	00 00 00 
80105cf7:	89 da                	mov    %ebx,%edx
80105cf9:	ec                   	in     (%dx),%al
80105cfa:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105cff:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105d00:	83 ec 08             	sub    $0x8,%esp
80105d03:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d08:	bb 28 7a 10 80       	mov    $0x80107a28,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d0d:	6a 00                	push   $0x0
80105d0f:	6a 04                	push   $0x4
80105d11:	e8 1a c7 ff ff       	call   80102430 <ioapicenable>
80105d16:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105d19:	b8 78 00 00 00       	mov    $0x78,%eax
80105d1e:	eb 04                	jmp    80105d24 <uartinit+0x94>
...
80105d54:	55                   	push   %ebp
  if(!uart)
80105d55:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
{
80105d5b:	89 e5                	mov    %esp,%ebp
80105d5d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105d60:	85 d2                	test   %edx,%edx
80105d62:	74 0c                	je     80105d70 <uartputc+0x20>
}
80105d64:	5d                   	pop    %ebp
80105d65:	e9 d6 fe ff ff       	jmp    80105c40 <uartputc.part.0>
...
80105d87:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105d8a:	68 10 5c 10 80       	push   $0x80105c10
80105d8f:	e8 cc aa ff ff       	call   80100860 <consoleintr>
}
...
80105d9b:	6a 00                	push   $0x0
  jmp alltraps
80105d9d:	e9 47 fb ff ff       	jmp    801058e9 <alltraps>
...
80105da4:	6a 01                	push   $0x1
  jmp alltraps
80105da6:	e9 3e fb ff ff       	jmp    801058e9 <alltraps>
...
80105dab:	6a 00                	push   $0x0
  pushl $2
80105dad:	6a 02                	push   $0x2
  jmp alltraps
80105daf:	e9 35 fb ff ff       	jmp    801058e9 <alltraps>
...
80105db4:	6a 00                	push   $0x0
  pushl $3
80105db6:	6a 03                	push   $0x3
  jmp alltraps
80105db8:	e9 2c fb ff ff       	jmp    801058e9 <alltraps>
...
80105dbf:	6a 04                	push   $0x4
  jmp alltraps
80105dc1:	e9 23 fb ff ff       	jmp    801058e9 <alltraps>
...
80105dc6:	6a 00                	push   $0x0
  pushl $5
80105dc8:	6a 05                	push   $0x5
  jmp alltraps
80105dca:	e9 1a fb ff ff       	jmp    801058e9 <alltraps>
...
80105dcf:	6a 00                	push   $0x0
  pushl $6
80105dd1:	6a 06                	push   $0x6
  jmp alltraps
80105dd3:	e9 11 fb ff ff       	jmp    801058e9 <alltraps>
...
80105dd8:	6a 00                	push   $0x0
  pushl $7
80105dda:	6a 07                	push   $0x7
  jmp alltraps
80105ddc:	e9 08 fb ff ff       	jmp    801058e9 <alltraps>

80105de1 <vector8>:
.globl vector8
vector8:
  pushl $8
80105de1:	6a 08                	push   $0x8
  jmp alltraps
80105de3:	e9 01 fb ff ff       	jmp    801058e9 <alltraps>
...
80105de8:	6a 00                	push   $0x0
  pushl $9
80105dea:	6a 09                	push   $0x9
  jmp alltraps
80105dec:	e9 f8 fa ff ff       	jmp    801058e9 <alltraps>

80105df1 <vector10>:
.globl vector10
vector10:
  pushl $10
80105df1:	6a 0a                	push   $0xa
  jmp alltraps
80105df3:	e9 f1 fa ff ff       	jmp    801058e9 <alltraps>

80105df8 <vector11>:
.globl vector11
vector11:
  pushl $11
80105df8:	6a 0b                	push   $0xb
  jmp alltraps
80105dfa:	e9 ea fa ff ff       	jmp    801058e9 <alltraps>

80105dff <vector12>:
.globl vector12
vector12:
  pushl $12
80105dff:	6a 0c                	push   $0xc
  jmp alltraps
80105e01:	e9 e3 fa ff ff       	jmp    801058e9 <alltraps>

80105e06 <vector13>:
.globl vector13
vector13:
  pushl $13
80105e06:	6a 0d                	push   $0xd
  jmp alltraps
80105e08:	e9 dc fa ff ff       	jmp    801058e9 <alltraps>

80105e0d <vector14>:
.globl vector14
vector14:
  pushl $14
80105e0d:	6a 0e                	push   $0xe
  jmp alltraps
80105e0f:	e9 d5 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e14:	6a 00                	push   $0x0
  pushl $15
80105e16:	6a 0f                	push   $0xf
  jmp alltraps
80105e18:	e9 cc fa ff ff       	jmp    801058e9 <alltraps>
...
80105e1d:	6a 00                	push   $0x0
  pushl $16
80105e1f:	6a 10                	push   $0x10
  jmp alltraps
80105e21:	e9 c3 fa ff ff       	jmp    801058e9 <alltraps>

80105e26 <vector17>:
.globl vector17
vector17:
  pushl $17
80105e26:	6a 11                	push   $0x11
  jmp alltraps
80105e28:	e9 bc fa ff ff       	jmp    801058e9 <alltraps>
...
80105e2d:	6a 00                	push   $0x0
  pushl $18
80105e2f:	6a 12                	push   $0x12
  jmp alltraps
80105e31:	e9 b3 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e36:	6a 00                	push   $0x0
  pushl $19
80105e38:	6a 13                	push   $0x13
  jmp alltraps
80105e3a:	e9 aa fa ff ff       	jmp    801058e9 <alltraps>
...
80105e3f:	6a 00                	push   $0x0
  pushl $20
80105e41:	6a 14                	push   $0x14
  jmp alltraps
80105e43:	e9 a1 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e48:	6a 00                	push   $0x0
  pushl $21
80105e4a:	6a 15                	push   $0x15
  jmp alltraps
80105e4c:	e9 98 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e51:	6a 00                	push   $0x0
  pushl $22
80105e53:	6a 16                	push   $0x16
  jmp alltraps
80105e55:	e9 8f fa ff ff       	jmp    801058e9 <alltraps>
...
80105e5a:	6a 00                	push   $0x0
  pushl $23
80105e5c:	6a 17                	push   $0x17
  jmp alltraps
80105e5e:	e9 86 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e63:	6a 00                	push   $0x0
  pushl $24
80105e65:	6a 18                	push   $0x18
  jmp alltraps
80105e67:	e9 7d fa ff ff       	jmp    801058e9 <alltraps>
...
80105e6c:	6a 00                	push   $0x0
  pushl $25
80105e6e:	6a 19                	push   $0x19
  jmp alltraps
80105e70:	e9 74 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e75:	6a 00                	push   $0x0
  pushl $26
80105e77:	6a 1a                	push   $0x1a
  jmp alltraps
80105e79:	e9 6b fa ff ff       	jmp    801058e9 <alltraps>
...
80105e7e:	6a 00                	push   $0x0
  pushl $27
80105e80:	6a 1b                	push   $0x1b
  jmp alltraps
80105e82:	e9 62 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e87:	6a 00                	push   $0x0
  pushl $28
80105e89:	6a 1c                	push   $0x1c
  jmp alltraps
80105e8b:	e9 59 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e90:	6a 00                	push   $0x0
  pushl $29
80105e92:	6a 1d                	push   $0x1d
  jmp alltraps
80105e94:	e9 50 fa ff ff       	jmp    801058e9 <alltraps>
...
80105e99:	6a 00                	push   $0x0
  pushl $30
80105e9b:	6a 1e                	push   $0x1e
  jmp alltraps
80105e9d:	e9 47 fa ff ff       	jmp    801058e9 <alltraps>
...
80105eab:	6a 00                	push   $0x0
  pushl $32
80105ead:	6a 20                	push   $0x20
  jmp alltraps
80105eaf:	e9 35 fa ff ff       	jmp    801058e9 <alltraps>
...
80105eb4:	6a 00                	push   $0x0
  pushl $33
80105eb6:	6a 21                	push   $0x21
  jmp alltraps
80105eb8:	e9 2c fa ff ff       	jmp    801058e9 <alltraps>
...
80105ebd:	6a 00                	push   $0x0
  pushl $34
80105ebf:	6a 22                	push   $0x22
  jmp alltraps
80105ec1:	e9 23 fa ff ff       	jmp    801058e9 <alltraps>
...
80105ec6:	6a 00                	push   $0x0
  pushl $35
80105ec8:	6a 23                	push   $0x23
  jmp alltraps
80105eca:	e9 1a fa ff ff       	jmp    801058e9 <alltraps>
...
80105ecf:	6a 00                	push   $0x0
  pushl $36
80105ed1:	6a 24                	push   $0x24
  jmp alltraps
80105ed3:	e9 11 fa ff ff       	jmp    801058e9 <alltraps>
...
80105ed8:	6a 00                	push   $0x0
  pushl $37
80105eda:	6a 25                	push   $0x25
  jmp alltraps
80105edc:	e9 08 fa ff ff       	jmp    801058e9 <alltraps>
...
80105ee1:	6a 00                	push   $0x0
  pushl $38
80105ee3:	6a 26                	push   $0x26
  jmp alltraps
80105ee5:	e9 ff f9 ff ff       	jmp    801058e9 <alltraps>
...
80105eea:	6a 00                	push   $0x0
  pushl $39
80105eec:	6a 27                	push   $0x27
  jmp alltraps
80105eee:	e9 f6 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105ef3:	6a 00                	push   $0x0
  pushl $40
80105ef5:	6a 28                	push   $0x28
  jmp alltraps
80105ef7:	e9 ed f9 ff ff       	jmp    801058e9 <alltraps>
...
80105efc:	6a 00                	push   $0x0
  pushl $41
80105efe:	6a 29                	push   $0x29
  jmp alltraps
80105f00:	e9 e4 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f05:	6a 00                	push   $0x0
  pushl $42
80105f07:	6a 2a                	push   $0x2a
  jmp alltraps
80105f09:	e9 db f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f0e:	6a 00                	push   $0x0
  pushl $43
80105f10:	6a 2b                	push   $0x2b
  jmp alltraps
80105f12:	e9 d2 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f17:	6a 00                	push   $0x0
  pushl $44
80105f19:	6a 2c                	push   $0x2c
  jmp alltraps
80105f1b:	e9 c9 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f20:	6a 00                	push   $0x0
  pushl $45
80105f22:	6a 2d                	push   $0x2d
  jmp alltraps
80105f24:	e9 c0 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f29:	6a 00                	push   $0x0
  pushl $46
80105f2b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f2d:	e9 b7 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f32:	6a 00                	push   $0x0
  pushl $47
80105f34:	6a 2f                	push   $0x2f
  jmp alltraps
80105f36:	e9 ae f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f3b:	6a 00                	push   $0x0
  pushl $48
80105f3d:	6a 30                	push   $0x30
  jmp alltraps
80105f3f:	e9 a5 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f44:	6a 00                	push   $0x0
  pushl $49
80105f46:	6a 31                	push   $0x31
  jmp alltraps
80105f48:	e9 9c f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f4d:	6a 00                	push   $0x0
  pushl $50
80105f4f:	6a 32                	push   $0x32
  jmp alltraps
80105f51:	e9 93 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f56:	6a 00                	push   $0x0
  pushl $51
80105f58:	6a 33                	push   $0x33
  jmp alltraps
80105f5a:	e9 8a f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f5f:	6a 00                	push   $0x0
  pushl $52
80105f61:	6a 34                	push   $0x34
  jmp alltraps
80105f63:	e9 81 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f68:	6a 00                	push   $0x0
  pushl $53
80105f6a:	6a 35                	push   $0x35
  jmp alltraps
80105f6c:	e9 78 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f71:	6a 00                	push   $0x0
  pushl $54
80105f73:	6a 36                	push   $0x36
  jmp alltraps
80105f75:	e9 6f f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f7a:	6a 00                	push   $0x0
  pushl $55
80105f7c:	6a 37                	push   $0x37
  jmp alltraps
80105f7e:	e9 66 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f83:	6a 00                	push   $0x0
  pushl $56
80105f85:	6a 38                	push   $0x38
  jmp alltraps
80105f87:	e9 5d f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f8c:	6a 00                	push   $0x0
  pushl $57
80105f8e:	6a 39                	push   $0x39
  jmp alltraps
80105f90:	e9 54 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f95:	6a 00                	push   $0x0
  pushl $58
80105f97:	6a 3a                	push   $0x3a
  jmp alltraps
80105f99:	e9 4b f9 ff ff       	jmp    801058e9 <alltraps>
...
80105f9e:	6a 00                	push   $0x0
  pushl $59
80105fa0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fa2:	e9 42 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fa7:	6a 00                	push   $0x0
  pushl $60
80105fa9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fab:	e9 39 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fb0:	6a 00                	push   $0x0
  pushl $61
80105fb2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fb4:	e9 30 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fb9:	6a 00                	push   $0x0
  pushl $62
80105fbb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fbd:	e9 27 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fc2:	6a 00                	push   $0x0
  pushl $63
80105fc4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fc6:	e9 1e f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fcb:	6a 00                	push   $0x0
  pushl $64
80105fcd:	6a 40                	push   $0x40
  jmp alltraps
80105fcf:	e9 15 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fd4:	6a 00                	push   $0x0
  pushl $65
80105fd6:	6a 41                	push   $0x41
  jmp alltraps
80105fd8:	e9 0c f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fdd:	6a 00                	push   $0x0
  pushl $66
80105fdf:	6a 42                	push   $0x42
  jmp alltraps
80105fe1:	e9 03 f9 ff ff       	jmp    801058e9 <alltraps>
...
80105fe6:	6a 00                	push   $0x0
  pushl $67
80105fe8:	6a 43                	push   $0x43
  jmp alltraps
80105fea:	e9 fa f8 ff ff       	jmp    801058e9 <alltraps>
...
80105fef:	6a 00                	push   $0x0
  pushl $68
80105ff1:	6a 44                	push   $0x44
  jmp alltraps
80105ff3:	e9 f1 f8 ff ff       	jmp    801058e9 <alltraps>
...
80105ff8:	6a 00                	push   $0x0
  pushl $69
80105ffa:	6a 45                	push   $0x45
  jmp alltraps
80105ffc:	e9 e8 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106001:	6a 00                	push   $0x0
  pushl $70
80106003:	6a 46                	push   $0x46
  jmp alltraps
80106005:	e9 df f8 ff ff       	jmp    801058e9 <alltraps>
...
8010600a:	6a 00                	push   $0x0
  pushl $71
8010600c:	6a 47                	push   $0x47
  jmp alltraps
8010600e:	e9 d6 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106013:	6a 00                	push   $0x0
  pushl $72
80106015:	6a 48                	push   $0x48
  jmp alltraps
80106017:	e9 cd f8 ff ff       	jmp    801058e9 <alltraps>
...
8010601c:	6a 00                	push   $0x0
  pushl $73
8010601e:	6a 49                	push   $0x49
  jmp alltraps
80106020:	e9 c4 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106025:	6a 00                	push   $0x0
  pushl $74
80106027:	6a 4a                	push   $0x4a
  jmp alltraps
80106029:	e9 bb f8 ff ff       	jmp    801058e9 <alltraps>
...
8010602e:	6a 00                	push   $0x0
  pushl $75
80106030:	6a 4b                	push   $0x4b
  jmp alltraps
80106032:	e9 b2 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106037:	6a 00                	push   $0x0
  pushl $76
80106039:	6a 4c                	push   $0x4c
  jmp alltraps
8010603b:	e9 a9 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106040:	6a 00                	push   $0x0
  pushl $77
80106042:	6a 4d                	push   $0x4d
  jmp alltraps
80106044:	e9 a0 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106049:	6a 00                	push   $0x0
  pushl $78
8010604b:	6a 4e                	push   $0x4e
  jmp alltraps
8010604d:	e9 97 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106052:	6a 00                	push   $0x0
  pushl $79
80106054:	6a 4f                	push   $0x4f
  jmp alltraps
80106056:	e9 8e f8 ff ff       	jmp    801058e9 <alltraps>
...
8010605b:	6a 00                	push   $0x0
  pushl $80
8010605d:	6a 50                	push   $0x50
  jmp alltraps
8010605f:	e9 85 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106064:	6a 00                	push   $0x0
  pushl $81
80106066:	6a 51                	push   $0x51
  jmp alltraps
80106068:	e9 7c f8 ff ff       	jmp    801058e9 <alltraps>
...
8010606d:	6a 00                	push   $0x0
  pushl $82
8010606f:	6a 52                	push   $0x52
  jmp alltraps
80106071:	e9 73 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106076:	6a 00                	push   $0x0
  pushl $83
80106078:	6a 53                	push   $0x53
  jmp alltraps
8010607a:	e9 6a f8 ff ff       	jmp    801058e9 <alltraps>
...
8010607f:	6a 00                	push   $0x0
  pushl $84
80106081:	6a 54                	push   $0x54
  jmp alltraps
80106083:	e9 61 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106088:	6a 00                	push   $0x0
  pushl $85
8010608a:	6a 55                	push   $0x55
  jmp alltraps
8010608c:	e9 58 f8 ff ff       	jmp    801058e9 <alltraps>
...
80106091:	6a 00                	push   $0x0
  pushl $86
80106093:	6a 56                	push   $0x56
  jmp alltraps
80106095:	e9 4f f8 ff ff       	jmp    801058e9 <alltraps>
...
8010609a:	6a 00                	push   $0x0
  pushl $87
8010609c:	6a 57                	push   $0x57
  jmp alltraps
8010609e:	e9 46 f8 ff ff       	jmp    801058e9 <alltraps>
...
801060a3:	6a 00                	push   $0x0
  pushl $88
801060a5:	6a 58                	push   $0x58
  jmp alltraps
801060a7:	e9 3d f8 ff ff       	jmp    801058e9 <alltraps>
...
801060ac:	6a 00                	push   $0x0
  pushl $89
801060ae:	6a 59                	push   $0x59
  jmp alltraps
801060b0:	e9 34 f8 ff ff       	jmp    801058e9 <alltraps>
...
801060b5:	6a 00                	push   $0x0
  pushl $90
801060b7:	6a 5a                	push   $0x5a
  jmp alltraps
801060b9:	e9 2b f8 ff ff       	jmp    801058e9 <alltraps>
...
801060be:	6a 00                	push   $0x0
  pushl $91
801060c0:	6a 5b                	push   $0x5b
  jmp alltraps
801060c2:	e9 22 f8 ff ff       	jmp    801058e9 <alltraps>
...
801060c7:	6a 00                	push   $0x0
  pushl $92
801060c9:	6a 5c                	push   $0x5c
  jmp alltraps
801060cb:	e9 19 f8 ff ff       	jmp    801058e9 <alltraps>
...
801060d0:	6a 00                	push   $0x0
  pushl $93
801060d2:	6a 5d                	push   $0x5d
  jmp alltraps
801060d4:	e9 10 f8 ff ff       	jmp    801058e9 <alltraps>
...
801060d9:	6a 00                	push   $0x0
  pushl $94
801060db:	6a 5e                	push   $0x5e
  jmp alltraps
801060dd:	e9 07 f8 ff ff       	jmp    801058e9 <alltraps>
...
801060e2:	6a 00                	push   $0x0
  pushl $95
801060e4:	6a 5f                	push   $0x5f
  jmp alltraps
801060e6:	e9 fe f7 ff ff       	jmp    801058e9 <alltraps>
...
801060eb:	6a 00                	push   $0x0
  pushl $96
801060ed:	6a 60                	push   $0x60
  jmp alltraps
801060ef:	e9 f5 f7 ff ff       	jmp    801058e9 <alltraps>
...
801060f4:	6a 00                	push   $0x0
  pushl $97
801060f6:	6a 61                	push   $0x61
  jmp alltraps
801060f8:	e9 ec f7 ff ff       	jmp    801058e9 <alltraps>
...
801060fd:	6a 00                	push   $0x0
  pushl $98
801060ff:	6a 62                	push   $0x62
  jmp alltraps
80106101:	e9 e3 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106106:	6a 00                	push   $0x0
  pushl $99
80106108:	6a 63                	push   $0x63
  jmp alltraps
8010610a:	e9 da f7 ff ff       	jmp    801058e9 <alltraps>
...
8010610f:	6a 00                	push   $0x0
  pushl $100
80106111:	6a 64                	push   $0x64
  jmp alltraps
80106113:	e9 d1 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106118:	6a 00                	push   $0x0
  pushl $101
8010611a:	6a 65                	push   $0x65
  jmp alltraps
8010611c:	e9 c8 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106121:	6a 00                	push   $0x0
  pushl $102
80106123:	6a 66                	push   $0x66
  jmp alltraps
80106125:	e9 bf f7 ff ff       	jmp    801058e9 <alltraps>
...
8010612a:	6a 00                	push   $0x0
  pushl $103
8010612c:	6a 67                	push   $0x67
  jmp alltraps
8010612e:	e9 b6 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106133:	6a 00                	push   $0x0
  pushl $104
80106135:	6a 68                	push   $0x68
  jmp alltraps
80106137:	e9 ad f7 ff ff       	jmp    801058e9 <alltraps>
...
8010613c:	6a 00                	push   $0x0
  pushl $105
8010613e:	6a 69                	push   $0x69
  jmp alltraps
80106140:	e9 a4 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106145:	6a 00                	push   $0x0
  pushl $106
80106147:	6a 6a                	push   $0x6a
  jmp alltraps
80106149:	e9 9b f7 ff ff       	jmp    801058e9 <alltraps>
...
8010614e:	6a 00                	push   $0x0
  pushl $107
80106150:	6a 6b                	push   $0x6b
  jmp alltraps
80106152:	e9 92 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106157:	6a 00                	push   $0x0
  pushl $108
80106159:	6a 6c                	push   $0x6c
  jmp alltraps
8010615b:	e9 89 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106160:	6a 00                	push   $0x0
  pushl $109
80106162:	6a 6d                	push   $0x6d
  jmp alltraps
80106164:	e9 80 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106169:	6a 00                	push   $0x0
  pushl $110
8010616b:	6a 6e                	push   $0x6e
  jmp alltraps
8010616d:	e9 77 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106172:	6a 00                	push   $0x0
  pushl $111
80106174:	6a 6f                	push   $0x6f
  jmp alltraps
80106176:	e9 6e f7 ff ff       	jmp    801058e9 <alltraps>
...
8010617b:	6a 00                	push   $0x0
  pushl $112
8010617d:	6a 70                	push   $0x70
  jmp alltraps
8010617f:	e9 65 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106184:	6a 00                	push   $0x0
  pushl $113
80106186:	6a 71                	push   $0x71
  jmp alltraps
80106188:	e9 5c f7 ff ff       	jmp    801058e9 <alltraps>
...
8010618d:	6a 00                	push   $0x0
  pushl $114
8010618f:	6a 72                	push   $0x72
  jmp alltraps
80106191:	e9 53 f7 ff ff       	jmp    801058e9 <alltraps>
...
80106196:	6a 00                	push   $0x0
  pushl $115
80106198:	6a 73                	push   $0x73
  jmp alltraps
8010619a:	e9 4a f7 ff ff       	jmp    801058e9 <alltraps>
...
8010619f:	6a 00                	push   $0x0
  pushl $116
801061a1:	6a 74                	push   $0x74
  jmp alltraps
801061a3:	e9 41 f7 ff ff       	jmp    801058e9 <alltraps>
...
801061a8:	6a 00                	push   $0x0
  pushl $117
801061aa:	6a 75                	push   $0x75
  jmp alltraps
801061ac:	e9 38 f7 ff ff       	jmp    801058e9 <alltraps>
...
801061b1:	6a 00                	push   $0x0
  pushl $118
801061b3:	6a 76                	push   $0x76
  jmp alltraps
801061b5:	e9 2f f7 ff ff       	jmp    801058e9 <alltraps>
...
801061ba:	6a 00                	push   $0x0
  pushl $119
801061bc:	6a 77                	push   $0x77
  jmp alltraps
801061be:	e9 26 f7 ff ff       	jmp    801058e9 <alltraps>
...
801061c3:	6a 00                	push   $0x0
  pushl $120
801061c5:	6a 78                	push   $0x78
  jmp alltraps
801061c7:	e9 1d f7 ff ff       	jmp    801058e9 <alltraps>
...
801061cc:	6a 00                	push   $0x0
  pushl $121
801061ce:	6a 79                	push   $0x79
  jmp alltraps
801061d0:	e9 14 f7 ff ff       	jmp    801058e9 <alltraps>
...
801061d5:	6a 00                	push   $0x0
  pushl $122
801061d7:	6a 7a                	push   $0x7a
  jmp alltraps
801061d9:	e9 0b f7 ff ff       	jmp    801058e9 <alltraps>
...
801061de:	6a 00                	push   $0x0
  pushl $123
801061e0:	6a 7b                	push   $0x7b
  jmp alltraps
801061e2:	e9 02 f7 ff ff       	jmp    801058e9 <alltraps>
...
801061e7:	6a 00                	push   $0x0
  pushl $124
801061e9:	6a 7c                	push   $0x7c
  jmp alltraps
801061eb:	e9 f9 f6 ff ff       	jmp    801058e9 <alltraps>
...
801061f0:	6a 00                	push   $0x0
  pushl $125
801061f2:	6a 7d                	push   $0x7d
  jmp alltraps
801061f4:	e9 f0 f6 ff ff       	jmp    801058e9 <alltraps>
...
801061f9:	6a 00                	push   $0x0
  pushl $126
801061fb:	6a 7e                	push   $0x7e
  jmp alltraps
801061fd:	e9 e7 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106202:	6a 00                	push   $0x0
  pushl $127
80106204:	6a 7f                	push   $0x7f
  jmp alltraps
80106206:	e9 de f6 ff ff       	jmp    801058e9 <alltraps>
...
8010620d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106212:	e9 d2 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106217:	6a 00                	push   $0x0
  pushl $129
80106219:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010621e:	e9 c6 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106223:	6a 00                	push   $0x0
  pushl $130
80106225:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010622a:	e9 ba f6 ff ff       	jmp    801058e9 <alltraps>
...
8010622f:	6a 00                	push   $0x0
  pushl $131
80106231:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106236:	e9 ae f6 ff ff       	jmp    801058e9 <alltraps>
...
8010623b:	6a 00                	push   $0x0
  pushl $132
8010623d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106242:	e9 a2 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106247:	6a 00                	push   $0x0
  pushl $133
80106249:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010624e:	e9 96 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106253:	6a 00                	push   $0x0
  pushl $134
80106255:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010625a:	e9 8a f6 ff ff       	jmp    801058e9 <alltraps>
...
8010625f:	6a 00                	push   $0x0
  pushl $135
80106261:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106266:	e9 7e f6 ff ff       	jmp    801058e9 <alltraps>
...
8010626b:	6a 00                	push   $0x0
  pushl $136
8010626d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106272:	e9 72 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106277:	6a 00                	push   $0x0
  pushl $137
80106279:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010627e:	e9 66 f6 ff ff       	jmp    801058e9 <alltraps>
...
80106283:	6a 00                	push   $0x0
  pushl $138
80106285:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010628a:	e9 5a f6 ff ff       	jmp    801058e9 <alltraps>
...
8010628f:	6a 00                	push   $0x0
  pushl $139
80106291:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106296:	e9 4e f6 ff ff       	jmp    801058e9 <alltraps>
...
8010629b:	6a 00                	push   $0x0
  pushl $140
8010629d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062a2:	e9 42 f6 ff ff       	jmp    801058e9 <alltraps>
...
801062a7:	6a 00                	push   $0x0
  pushl $141
801062a9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ae:	e9 36 f6 ff ff       	jmp    801058e9 <alltraps>
...
801062b3:	6a 00                	push   $0x0
  pushl $142
801062b5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062ba:	e9 2a f6 ff ff       	jmp    801058e9 <alltraps>
...
801062bf:	6a 00                	push   $0x0
  pushl $143
801062c1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062c6:	e9 1e f6 ff ff       	jmp    801058e9 <alltraps>
...
801062cb:	6a 00                	push   $0x0
  pushl $144
801062cd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062d2:	e9 12 f6 ff ff       	jmp    801058e9 <alltraps>
...
801062d7:	6a 00                	push   $0x0
  pushl $145
801062d9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062de:	e9 06 f6 ff ff       	jmp    801058e9 <alltraps>
...
801062e3:	6a 00                	push   $0x0
  pushl $146
801062e5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062ea:	e9 fa f5 ff ff       	jmp    801058e9 <alltraps>
...
801062ef:	6a 00                	push   $0x0
  pushl $147
801062f1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062f6:	e9 ee f5 ff ff       	jmp    801058e9 <alltraps>
...
801062fb:	6a 00                	push   $0x0
  pushl $148
801062fd:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106302:	e9 e2 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106307:	6a 00                	push   $0x0
  pushl $149
80106309:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010630e:	e9 d6 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106313:	6a 00                	push   $0x0
  pushl $150
80106315:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010631a:	e9 ca f5 ff ff       	jmp    801058e9 <alltraps>
...
8010631f:	6a 00                	push   $0x0
  pushl $151
80106321:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106326:	e9 be f5 ff ff       	jmp    801058e9 <alltraps>
...
8010632b:	6a 00                	push   $0x0
  pushl $152
8010632d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106332:	e9 b2 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106337:	6a 00                	push   $0x0
  pushl $153
80106339:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010633e:	e9 a6 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106343:	6a 00                	push   $0x0
  pushl $154
80106345:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010634a:	e9 9a f5 ff ff       	jmp    801058e9 <alltraps>
...
8010634f:	6a 00                	push   $0x0
  pushl $155
80106351:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106356:	e9 8e f5 ff ff       	jmp    801058e9 <alltraps>
...
8010635b:	6a 00                	push   $0x0
  pushl $156
8010635d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106362:	e9 82 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106367:	6a 00                	push   $0x0
  pushl $157
80106369:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010636e:	e9 76 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106373:	6a 00                	push   $0x0
  pushl $158
80106375:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010637a:	e9 6a f5 ff ff       	jmp    801058e9 <alltraps>
...
8010637f:	6a 00                	push   $0x0
  pushl $159
80106381:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106386:	e9 5e f5 ff ff       	jmp    801058e9 <alltraps>
...
8010638b:	6a 00                	push   $0x0
  pushl $160
8010638d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106392:	e9 52 f5 ff ff       	jmp    801058e9 <alltraps>
...
80106397:	6a 00                	push   $0x0
  pushl $161
80106399:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010639e:	e9 46 f5 ff ff       	jmp    801058e9 <alltraps>
...
801063a3:	6a 00                	push   $0x0
  pushl $162
801063a5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063aa:	e9 3a f5 ff ff       	jmp    801058e9 <alltraps>
...
801063af:	6a 00                	push   $0x0
  pushl $163
801063b1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063b6:	e9 2e f5 ff ff       	jmp    801058e9 <alltraps>
...
801063bb:	6a 00                	push   $0x0
  pushl $164
801063bd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063c2:	e9 22 f5 ff ff       	jmp    801058e9 <alltraps>
...
801063c7:	6a 00                	push   $0x0
  pushl $165
801063c9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ce:	e9 16 f5 ff ff       	jmp    801058e9 <alltraps>
...
801063d3:	6a 00                	push   $0x0
  pushl $166
801063d5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063da:	e9 0a f5 ff ff       	jmp    801058e9 <alltraps>
...
801063df:	6a 00                	push   $0x0
  pushl $167
801063e1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063e6:	e9 fe f4 ff ff       	jmp    801058e9 <alltraps>
...
801063eb:	6a 00                	push   $0x0
  pushl $168
801063ed:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063f2:	e9 f2 f4 ff ff       	jmp    801058e9 <alltraps>
...
801063f7:	6a 00                	push   $0x0
  pushl $169
801063f9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063fe:	e9 e6 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106403:	6a 00                	push   $0x0
  pushl $170
80106405:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010640a:	e9 da f4 ff ff       	jmp    801058e9 <alltraps>
...
8010640f:	6a 00                	push   $0x0
  pushl $171
80106411:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106416:	e9 ce f4 ff ff       	jmp    801058e9 <alltraps>
...
8010641b:	6a 00                	push   $0x0
  pushl $172
8010641d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106422:	e9 c2 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106427:	6a 00                	push   $0x0
  pushl $173
80106429:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010642e:	e9 b6 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106433:	6a 00                	push   $0x0
  pushl $174
80106435:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010643a:	e9 aa f4 ff ff       	jmp    801058e9 <alltraps>
...
8010643f:	6a 00                	push   $0x0
  pushl $175
80106441:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106446:	e9 9e f4 ff ff       	jmp    801058e9 <alltraps>
...
8010644b:	6a 00                	push   $0x0
  pushl $176
8010644d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106452:	e9 92 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106457:	6a 00                	push   $0x0
  pushl $177
80106459:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010645e:	e9 86 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106463:	6a 00                	push   $0x0
  pushl $178
80106465:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010646a:	e9 7a f4 ff ff       	jmp    801058e9 <alltraps>
...
8010646f:	6a 00                	push   $0x0
  pushl $179
80106471:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106476:	e9 6e f4 ff ff       	jmp    801058e9 <alltraps>
...
8010647b:	6a 00                	push   $0x0
  pushl $180
8010647d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106482:	e9 62 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106487:	6a 00                	push   $0x0
  pushl $181
80106489:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010648e:	e9 56 f4 ff ff       	jmp    801058e9 <alltraps>
...
80106493:	6a 00                	push   $0x0
  pushl $182
80106495:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010649a:	e9 4a f4 ff ff       	jmp    801058e9 <alltraps>
...
8010649f:	6a 00                	push   $0x0
  pushl $183
801064a1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064a6:	e9 3e f4 ff ff       	jmp    801058e9 <alltraps>
...
801064ab:	6a 00                	push   $0x0
  pushl $184
801064ad:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064b2:	e9 32 f4 ff ff       	jmp    801058e9 <alltraps>
...
801064b7:	6a 00                	push   $0x0
  pushl $185
801064b9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064be:	e9 26 f4 ff ff       	jmp    801058e9 <alltraps>
...
801064c3:	6a 00                	push   $0x0
  pushl $186
801064c5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064ca:	e9 1a f4 ff ff       	jmp    801058e9 <alltraps>
...
801064cf:	6a 00                	push   $0x0
  pushl $187
801064d1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064d6:	e9 0e f4 ff ff       	jmp    801058e9 <alltraps>
...
801064db:	6a 00                	push   $0x0
  pushl $188
801064dd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064e2:	e9 02 f4 ff ff       	jmp    801058e9 <alltraps>
...
801064e7:	6a 00                	push   $0x0
  pushl $189
801064e9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064ee:	e9 f6 f3 ff ff       	jmp    801058e9 <alltraps>
...
801064f3:	6a 00                	push   $0x0
  pushl $190
801064f5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064fa:	e9 ea f3 ff ff       	jmp    801058e9 <alltraps>
...
801064ff:	6a 00                	push   $0x0
  pushl $191
80106501:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106506:	e9 de f3 ff ff       	jmp    801058e9 <alltraps>
...
8010650b:	6a 00                	push   $0x0
  pushl $192
8010650d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106512:	e9 d2 f3 ff ff       	jmp    801058e9 <alltraps>
...
80106517:	6a 00                	push   $0x0
  pushl $193
80106519:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010651e:	e9 c6 f3 ff ff       	jmp    801058e9 <alltraps>
...
80106523:	6a 00                	push   $0x0
  pushl $194
80106525:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010652a:	e9 ba f3 ff ff       	jmp    801058e9 <alltraps>
...
8010652f:	6a 00                	push   $0x0
  pushl $195
80106531:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106536:	e9 ae f3 ff ff       	jmp    801058e9 <alltraps>
...
8010653b:	6a 00                	push   $0x0
  pushl $196
8010653d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106542:	e9 a2 f3 ff ff       	jmp    801058e9 <alltraps>
...
80106547:	6a 00                	push   $0x0
  pushl $197
80106549:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010654e:	e9 96 f3 ff ff       	jmp    801058e9 <alltraps>
...
80106553:	6a 00                	push   $0x0
  pushl $198
80106555:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010655a:	e9 8a f3 ff ff       	jmp    801058e9 <alltraps>
...
8010655f:	6a 00                	push   $0x0
  pushl $199
80106561:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106566:	e9 7e f3 ff ff       	jmp    801058e9 <alltraps>
...
8010656b:	6a 00                	push   $0x0
  pushl $200
8010656d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106572:	e9 72 f3 ff ff       	jmp    801058e9 <alltraps>
...
80106577:	6a 00                	push   $0x0
  pushl $201
80106579:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010657e:	e9 66 f3 ff ff       	jmp    801058e9 <alltraps>
...
80106583:	6a 00                	push   $0x0
  pushl $202
80106585:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010658a:	e9 5a f3 ff ff       	jmp    801058e9 <alltraps>
...
8010658f:	6a 00                	push   $0x0
  pushl $203
80106591:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106596:	e9 4e f3 ff ff       	jmp    801058e9 <alltraps>
...
8010659b:	6a 00                	push   $0x0
  pushl $204
8010659d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065a2:	e9 42 f3 ff ff       	jmp    801058e9 <alltraps>
...
801065a7:	6a 00                	push   $0x0
  pushl $205
801065a9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ae:	e9 36 f3 ff ff       	jmp    801058e9 <alltraps>
...
801065b3:	6a 00                	push   $0x0
  pushl $206
801065b5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065ba:	e9 2a f3 ff ff       	jmp    801058e9 <alltraps>
...
801065bf:	6a 00                	push   $0x0
  pushl $207
801065c1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065c6:	e9 1e f3 ff ff       	jmp    801058e9 <alltraps>
...
801065cb:	6a 00                	push   $0x0
  pushl $208
801065cd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065d2:	e9 12 f3 ff ff       	jmp    801058e9 <alltraps>
...
801065d7:	6a 00                	push   $0x0
  pushl $209
801065d9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065de:	e9 06 f3 ff ff       	jmp    801058e9 <alltraps>
...
801065e3:	6a 00                	push   $0x0
  pushl $210
801065e5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065ea:	e9 fa f2 ff ff       	jmp    801058e9 <alltraps>
...
801065ef:	6a 00                	push   $0x0
  pushl $211
801065f1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065f6:	e9 ee f2 ff ff       	jmp    801058e9 <alltraps>
...
801065fb:	6a 00                	push   $0x0
  pushl $212
801065fd:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106602:	e9 e2 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106607:	6a 00                	push   $0x0
  pushl $213
80106609:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010660e:	e9 d6 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106613:	6a 00                	push   $0x0
  pushl $214
80106615:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010661a:	e9 ca f2 ff ff       	jmp    801058e9 <alltraps>
...
8010661f:	6a 00                	push   $0x0
  pushl $215
80106621:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106626:	e9 be f2 ff ff       	jmp    801058e9 <alltraps>
...
8010662b:	6a 00                	push   $0x0
  pushl $216
8010662d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106632:	e9 b2 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106637:	6a 00                	push   $0x0
  pushl $217
80106639:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010663e:	e9 a6 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106643:	6a 00                	push   $0x0
  pushl $218
80106645:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010664a:	e9 9a f2 ff ff       	jmp    801058e9 <alltraps>
...
8010664f:	6a 00                	push   $0x0
  pushl $219
80106651:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106656:	e9 8e f2 ff ff       	jmp    801058e9 <alltraps>
...
8010665b:	6a 00                	push   $0x0
  pushl $220
8010665d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106662:	e9 82 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106667:	6a 00                	push   $0x0
  pushl $221
80106669:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010666e:	e9 76 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106673:	6a 00                	push   $0x0
  pushl $222
80106675:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010667a:	e9 6a f2 ff ff       	jmp    801058e9 <alltraps>
...
8010667f:	6a 00                	push   $0x0
  pushl $223
80106681:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106686:	e9 5e f2 ff ff       	jmp    801058e9 <alltraps>
...
8010668b:	6a 00                	push   $0x0
  pushl $224
8010668d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106692:	e9 52 f2 ff ff       	jmp    801058e9 <alltraps>
...
80106697:	6a 00                	push   $0x0
  pushl $225
80106699:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010669e:	e9 46 f2 ff ff       	jmp    801058e9 <alltraps>
...
801066a3:	6a 00                	push   $0x0
  pushl $226
801066a5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066aa:	e9 3a f2 ff ff       	jmp    801058e9 <alltraps>
...
801066af:	6a 00                	push   $0x0
  pushl $227
801066b1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066b6:	e9 2e f2 ff ff       	jmp    801058e9 <alltraps>
...
801066bb:	6a 00                	push   $0x0
  pushl $228
801066bd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066c2:	e9 22 f2 ff ff       	jmp    801058e9 <alltraps>
...
801066c7:	6a 00                	push   $0x0
  pushl $229
801066c9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ce:	e9 16 f2 ff ff       	jmp    801058e9 <alltraps>
...
801066d3:	6a 00                	push   $0x0
  pushl $230
801066d5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066da:	e9 0a f2 ff ff       	jmp    801058e9 <alltraps>
...
801066df:	6a 00                	push   $0x0
  pushl $231
801066e1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066e6:	e9 fe f1 ff ff       	jmp    801058e9 <alltraps>
...
801066eb:	6a 00                	push   $0x0
  pushl $232
801066ed:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066f2:	e9 f2 f1 ff ff       	jmp    801058e9 <alltraps>
...
801066f7:	6a 00                	push   $0x0
  pushl $233
801066f9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066fe:	e9 e6 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106703:	6a 00                	push   $0x0
  pushl $234
80106705:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010670a:	e9 da f1 ff ff       	jmp    801058e9 <alltraps>
...
8010670f:	6a 00                	push   $0x0
  pushl $235
80106711:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106716:	e9 ce f1 ff ff       	jmp    801058e9 <alltraps>
...
8010671b:	6a 00                	push   $0x0
  pushl $236
8010671d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106722:	e9 c2 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106727:	6a 00                	push   $0x0
  pushl $237
80106729:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010672e:	e9 b6 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106733:	6a 00                	push   $0x0
  pushl $238
80106735:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010673a:	e9 aa f1 ff ff       	jmp    801058e9 <alltraps>
...
8010673f:	6a 00                	push   $0x0
  pushl $239
80106741:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106746:	e9 9e f1 ff ff       	jmp    801058e9 <alltraps>
...
8010674b:	6a 00                	push   $0x0
  pushl $240
8010674d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106752:	e9 92 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106757:	6a 00                	push   $0x0
  pushl $241
80106759:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010675e:	e9 86 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106763:	6a 00                	push   $0x0
  pushl $242
80106765:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010676a:	e9 7a f1 ff ff       	jmp    801058e9 <alltraps>
...
8010676f:	6a 00                	push   $0x0
  pushl $243
80106771:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106776:	e9 6e f1 ff ff       	jmp    801058e9 <alltraps>
...
8010677b:	6a 00                	push   $0x0
  pushl $244
8010677d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106782:	e9 62 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106787:	6a 00                	push   $0x0
  pushl $245
80106789:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010678e:	e9 56 f1 ff ff       	jmp    801058e9 <alltraps>
...
80106793:	6a 00                	push   $0x0
  pushl $246
80106795:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
8010679a:	e9 4a f1 ff ff       	jmp    801058e9 <alltraps>
...
8010679f:	6a 00                	push   $0x0
  pushl $247
801067a1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067a6:	e9 3e f1 ff ff       	jmp    801058e9 <alltraps>
...
801067ab:	6a 00                	push   $0x0
  pushl $248
801067ad:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067b2:	e9 32 f1 ff ff       	jmp    801058e9 <alltraps>
...
801067b7:	6a 00                	push   $0x0
  pushl $249
801067b9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067be:	e9 26 f1 ff ff       	jmp    801058e9 <alltraps>
...
801067c3:	6a 00                	push   $0x0
  pushl $250
801067c5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067ca:	e9 1a f1 ff ff       	jmp    801058e9 <alltraps>
...
801067cf:	6a 00                	push   $0x0
  pushl $251
801067d1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067d6:	e9 0e f1 ff ff       	jmp    801058e9 <alltraps>
...
801067db:	6a 00                	push   $0x0
  pushl $252
801067dd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067e2:	e9 02 f1 ff ff       	jmp    801058e9 <alltraps>
...
801067e7:	6a 00                	push   $0x0
  pushl $253
801067e9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ee:	e9 f6 f0 ff ff       	jmp    801058e9 <alltraps>
...
801067f3:	6a 00                	push   $0x0
  pushl $254
801067f5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067fa:	e9 ea f0 ff ff       	jmp    801058e9 <alltraps>
...
801067ff:	6a 00                	push   $0x0
  pushl $255
80106801:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106806:	e9 de f0 ff ff       	jmp    801058e9 <alltraps>
...
80106854:	e8 d7 bd ff ff       	call   80102630 <kalloc>
...
8010686a:	e8 61 de ff ff       	call   801046d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010690d:	68 30 7a 10 80       	push   $0x80107a30
...
801069c3:	68 c6 73 10 80       	push   $0x801073c6
...
801069d7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069da:	e8 61 cf ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106a64:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106a8a:	83 ec 1c             	sub    $0x1c,%esp
80106a8d:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106a90:	85 f6                	test   %esi,%esi
80106a92:	0f 84 cb 00 00 00    	je     80106b63 <switchuvm+0xe3>
  if(p->kstack == 0)
80106a98:	8b 46 08             	mov    0x8(%esi),%eax
80106a9b:	85 c0                	test   %eax,%eax
80106a9d:	0f 84 da 00 00 00    	je     80106b7d <switchuvm+0xfd>
  if(p->pgdir == 0)
80106aa3:	8b 46 04             	mov    0x4(%esi),%eax
80106aa6:	85 c0                	test   %eax,%eax
80106aa8:	0f 84 c2 00 00 00    	je     80106b70 <switchuvm+0xf0>
  pushcli();
80106aae:	e8 0d da ff ff       	call   801044c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ab3:	e8 18 ce ff ff       	call   801038d0 <mycpu>
80106ab8:	89 c3                	mov    %eax,%ebx
80106aba:	e8 11 ce ff ff       	call   801038d0 <mycpu>
80106abf:	89 c7                	mov    %eax,%edi
80106ac1:	e8 0a ce ff ff       	call   801038d0 <mycpu>
80106ac6:	83 c7 08             	add    $0x8,%edi
80106ac9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106acc:	e8 ff cd ff ff       	call   801038d0 <mycpu>
80106ad1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106ad4:	ba 67 00 00 00       	mov    $0x67,%edx
80106ad9:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106ae0:	83 c0 08             	add    $0x8,%eax
80106ae3:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106aea:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106aef:	83 c1 08             	add    $0x8,%ecx
80106af2:	c1 e8 18             	shr    $0x18,%eax
80106af5:	c1 e9 10             	shr    $0x10,%ecx
80106af8:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106afe:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106b04:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106b09:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106b10:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106b15:	e8 b6 cd ff ff       	call   801038d0 <mycpu>
80106b1a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106b21:	e8 aa cd ff ff       	call   801038d0 <mycpu>
80106b26:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106b2a:	8b 5e 08             	mov    0x8(%esi),%ebx
80106b2d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b33:	e8 98 cd ff ff       	call   801038d0 <mycpu>
80106b38:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b3b:	e8 90 cd ff ff       	call   801038d0 <mycpu>
80106b40:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106b44:	b8 28 00 00 00       	mov    $0x28,%eax
80106b49:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106b4c:	8b 46 04             	mov    0x4(%esi),%eax
80106b4f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106b54:	0f 22 d8             	mov    %eax,%cr3
}
...
80106b5d:	5d                   	pop    %ebp
  popcli();
80106b5e:	e9 ad d9 ff ff       	jmp    80104510 <popcli>
    panic("switchuvm: no process");
80106b63:	83 ec 0c             	sub    $0xc,%esp
80106b66:	68 36 7a 10 80       	push   $0x80107a36
80106b6b:	e8 20 98 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106b70:	83 ec 0c             	sub    $0xc,%esp
80106b73:	68 61 7a 10 80       	push   $0x80107a61
80106b78:	e8 13 98 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106b7d:	83 ec 0c             	sub    $0xc,%esp
80106b80:	68 4c 7a 10 80       	push   $0x80107a4c
80106b85:	e8 06 98 ff ff       	call   80100390 <panic>
...
80106ba0:	8b 75 10             	mov    0x10(%ebp),%esi
80106ba3:	8b 7d 08             	mov    0x8(%ebp),%edi
80106ba6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106ba9:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106baf:	77 4b                	ja     80106bfc <inituvm+0x6c>
  mem = kalloc();
80106bb1:	e8 7a ba ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106bb6:	83 ec 04             	sub    $0x4,%esp
80106bb9:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106bbe:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106bc0:	6a 00                	push   $0x0
80106bc2:	50                   	push   %eax
80106bc3:	e8 08 db ff ff       	call   801046d0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106bc8:	58                   	pop    %eax
80106bc9:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106bcf:	5a                   	pop    %edx
80106bd0:	6a 06                	push   $0x6
80106bd2:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106bd7:	31 d2                	xor    %edx,%edx
80106bd9:	50                   	push   %eax
80106bda:	89 f8                	mov    %edi,%eax
80106bdc:	e8 af fc ff ff       	call   80106890 <mappages>
  memmove(mem, init, sz);
80106be1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106be4:	89 75 10             	mov    %esi,0x10(%ebp)
80106be7:	83 c4 10             	add    $0x10,%esp
80106bea:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106bed:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106bf6:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bf7:	e9 74 db ff ff       	jmp    80104770 <memmove>
    panic("inituvm: more than a page");
80106bfc:	83 ec 0c             	sub    $0xc,%esp
80106bff:	68 75 7a 10 80       	push   $0x80107a75
...
80106c20:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106c23:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106c28:	0f 85 99 00 00 00    	jne    80106cc7 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106c2e:	01 f0                	add    %esi,%eax
80106c30:	89 f3                	mov    %esi,%ebx
80106c32:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c35:	8b 45 14             	mov    0x14(%ebp),%eax
80106c38:	01 f0                	add    %esi,%eax
80106c3a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106c3d:	85 f6                	test   %esi,%esi
80106c3f:	75 15                	jne    80106c56 <loaduvm+0x46>
80106c41:	eb 6d                	jmp    80106cb0 <loaduvm+0xa0>
80106c43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106c47:	90                   	nop
80106c48:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c4e:	89 f0                	mov    %esi,%eax
80106c50:	29 d8                	sub    %ebx,%eax
80106c52:	39 c6                	cmp    %eax,%esi
80106c54:	76 5a                	jbe    80106cb0 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106c56:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106c59:	8b 45 08             	mov    0x8(%ebp),%eax
80106c5c:	31 c9                	xor    %ecx,%ecx
80106c5e:	29 da                	sub    %ebx,%edx
80106c60:	e8 ab fb ff ff       	call   80106810 <walkpgdir>
80106c65:	85 c0                	test   %eax,%eax
80106c67:	74 51                	je     80106cba <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
...
80106c8b:	ff 75 10             	pushl  0x10(%ebp)
80106c8e:	e8 cd ad ff ff       	call   80101a60 <readi>
80106c93:	83 c4 10             	add    $0x10,%esp
80106c96:	39 f8                	cmp    %edi,%eax
80106c98:	74 ae                	je     80106c48 <loaduvm+0x38>
}
...
80106ce9:	53                   	push   %ebx
80106cea:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106ced:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106cf0:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106cf3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cf6:	85 c0                	test   %eax,%eax
80106cf8:	0f 88 b2 00 00 00    	js     80106db0 <allocuvm+0xd0>
  if(newsz < oldsz)
80106cfe:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106d01:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106d04:	0f 82 96 00 00 00    	jb     80106da0 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106d0a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106d10:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106d16:	39 75 10             	cmp    %esi,0x10(%ebp)
80106d19:	77 40                	ja     80106d5b <allocuvm+0x7b>
80106d1b:	e9 83 00 00 00       	jmp    80106da3 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106d20:	83 ec 04             	sub    $0x4,%esp
80106d23:	68 00 10 00 00       	push   $0x1000
80106d28:	6a 00                	push   $0x0
80106d2a:	50                   	push   %eax
80106d2b:	e8 a0 d9 ff ff       	call   801046d0 <memset>
...
80106d44:	e8 47 fb ff ff       	call   80106890 <mappages>
...
80106d59:	76 48                	jbe    80106da3 <allocuvm+0xc3>
    mem = kalloc();
80106d5b:	e8 d0 b8 ff ff       	call   80102630 <kalloc>
...
80106d69:	68 ad 7a 10 80       	push   $0x80107aad
80106d6e:	e8 3d 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106d85:	e8 96 fb ff ff       	call   80106920 <deallocuvm.part.0>
      return 0;
...
80106dcb:	68 c5 7a 10 80       	push   $0x80107ac5
80106dd0:	e8 db 98 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106de7:	e8 34 fb ff ff       	call   80106920 <deallocuvm.part.0>
      kfree(mem);
80106dec:	83 ec 0c             	sub    $0xc,%esp
80106def:	53                   	push   %ebx
80106df0:	e8 7b b6 ff ff       	call   80102470 <kfree>
      return 0;
...
80106e17:	8b 55 0c             	mov    0xc(%ebp),%edx
80106e1a:	8b 4d 10             	mov    0x10(%ebp),%ecx
80106e1d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80106e20:	39 d1                	cmp    %edx,%ecx
80106e22:	73 0c                	jae    80106e30 <deallocuvm+0x20>
}
80106e24:	5d                   	pop    %ebp
80106e25:	e9 f6 fa ff ff       	jmp    80106920 <deallocuvm.part.0>
...
80106e4d:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106e50:	85 f6                	test   %esi,%esi
80106e52:	74 55                	je     80106ea9 <freevm+0x69>
  if(newsz >= oldsz)
80106e54:	31 c9                	xor    %ecx,%ecx
80106e56:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106e5b:	89 f0                	mov    %esi,%eax
80106e5d:	89 f3                	mov    %esi,%ebx
80106e5f:	e8 bc fa ff ff       	call   80106920 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106e64:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106e6a:	eb 0b                	jmp    80106e77 <freevm+0x37>
...
80106e8e:	e8 dd b5 ff ff       	call   80102470 <kfree>
...
80106ea3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ea4:	e9 c7 b5 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
...
80106ec9:	e8 62 b7 ff ff       	call   80102630 <kalloc>
80106ece:	89 c6                	mov    %eax,%esi
80106ed0:	85 c0                	test   %eax,%eax
80106ed2:	74 42                	je     80106f16 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80106ed4:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106ed7:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106edc:	68 00 10 00 00       	push   $0x1000
80106ee1:	6a 00                	push   $0x0
80106ee3:	50                   	push   %eax
80106ee4:	e8 e7 d7 ff ff       	call   801046d0 <memset>
80106ee9:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80106eec:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106eef:	83 ec 08             	sub    $0x8,%esp
80106ef2:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106ef5:	ff 73 0c             	pushl  0xc(%ebx)
80106ef8:	8b 13                	mov    (%ebx),%edx
80106efa:	50                   	push   %eax
80106efb:	29 c1                	sub    %eax,%ecx
80106efd:	89 f0                	mov    %esi,%eax
80106eff:	e8 8c f9 ff ff       	call   80106890 <mappages>
80106f04:	83 c4 10             	add    $0x10,%esp
80106f07:	85 c0                	test   %eax,%eax
80106f09:	78 15                	js     80106f20 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106f0b:	83 c3 10             	add    $0x10,%ebx
80106f0e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106f14:	75 d6                	jne    80106eec <setupkvm+0x2c>
}
80106f16:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80106f47:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106f4a:	e8 71 ff ff ff       	call   80106ec0 <setupkvm>
80106f4f:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106f54:	05 00 00 00 80       	add    $0x80000000,%eax
80106f59:	0f 22 d8             	mov    %eax,%cr3
}
80106f5c:	c9                   	leave  
80106f5d:	c3                   	ret    
...
80106f72:	e8 99 f8 ff ff       	call   80106810 <walkpgdir>
  if(pte == 0)
80106f77:	85 c0                	test   %eax,%eax
80106f79:	74 05                	je     80106f80 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106f7b:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106f7e:	c9                   	leave  
80106f7f:	c3                   	ret    
    panic("clearpteu");
80106f80:	83 ec 0c             	sub    $0xc,%esp
80106f83:	68 f2 7a 10 80       	push   $0x80107af2
...
80106f9a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106f9d:	e8 1e ff ff ff       	call   80106ec0 <setupkvm>
80106fa2:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106fa5:	85 c0                	test   %eax,%eax
80106fa7:	0f 84 9b 00 00 00    	je     80107048 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106fad:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106fb0:	85 c9                	test   %ecx,%ecx
80106fb2:	0f 84 90 00 00 00    	je     80107048 <copyuvm+0xb8>
80106fb8:	31 f6                	xor    %esi,%esi
80106fba:	eb 46                	jmp    80107002 <copyuvm+0x72>
...
80107007:	89 f2                	mov    %esi,%edx
80107009:	e8 02 f8 ff ff       	call   80106810 <walkpgdir>
...
80107016:	74 4e                	je     80107066 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80107018:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
8010701a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010701f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107022:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107028:	e8 03 b6 ff ff       	call   80102630 <kalloc>
8010702d:	89 c3                	mov    %eax,%ebx
...
80107039:	e8 02 fe ff ff       	call   80106e40 <freevm>
  return 0;
8010703e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107051:	5d                   	pop    %ebp
80107052:	c3                   	ret    
80107053:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107057:	90                   	nop
      kfree(mem);
80107058:	83 ec 0c             	sub    $0xc,%esp
8010705b:	53                   	push   %ebx
8010705c:	e8 0f b4 ff ff       	call   80102470 <kfree>
      goto bad;
...
80107092:	e8 79 f7 ff ff       	call   80106810 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107099:	c9                   	leave  
  if((*pte & PTE_U) == 0)
8010709a:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
8010709c:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801070a1:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801070a4:	05 00 00 00 80       	add    $0x80000000,%eax
801070a9:	83 fa 05             	cmp    $0x5,%edx
801070ac:	ba 00 00 00 00       	mov    $0x0,%edx
801070b1:	0f 45 c2             	cmovne %edx,%eax
}
801070b4:	c3                   	ret    
...
801070cd:	8b 75 14             	mov    0x14(%ebp),%esi
801070d0:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
801070d3:	85 f6                	test   %esi,%esi
801070d5:	75 3c                	jne    80107113 <copyout+0x53>
801070d7:	eb 67                	jmp    80107140 <copyout+0x80>
...
801070e3:	89 fb                	mov    %edi,%ebx
801070e5:	29 d3                	sub    %edx,%ebx
801070e7:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801070ed:	39 f3                	cmp    %esi,%ebx
801070ef:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801070f2:	29 fa                	sub    %edi,%edx
801070f4:	83 ec 04             	sub    $0x4,%esp
801070f7:	01 c2                	add    %eax,%edx
801070f9:	53                   	push   %ebx
801070fa:	ff 75 10             	pushl  0x10(%ebp)
801070fd:	52                   	push   %edx
801070fe:	e8 6d d6 ff ff       	call   80104770 <memmove>
    len -= n;
    buf += n;
80107103:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107106:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010710c:	83 c4 10             	add    $0x10,%esp
8010710f:	29 de                	sub    %ebx,%esi
80107111:	74 2d                	je     80107140 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107113:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107115:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107118:	89 55 0c             	mov    %edx,0xc(%ebp)
8010711b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107121:	57                   	push   %edi
80107122:	ff 75 08             	pushl  0x8(%ebp)
80107125:	e8 56 ff ff ff       	call   80107080 <uva2ka>
    if(pa0 == 0)
8010712a:	83 c4 10             	add    $0x10,%esp
8010712d:	85 c0                	test   %eax,%eax
8010712f:	75 af                	jne    801070e0 <copyout+0x20>
  }
  return 0;
}
