...
8010005a:	e8 01 44 00 00       	call   80104460 <initlock>
  bcache.head.next = &bcache.head;
...
801000e8:	e8 f3 44 00 00       	call   801045e0 <acquire>
...
801001c2:	e8 39 42 00 00       	call   80104400 <holdingsleep>
...
80100203:	e8 f8 41 00 00       	call   80104400 <holdingsleep>
...
80100213:	e8 a8 41 00 00       	call   801043c0 <releasesleep>

  acquire(&bcache.lock);
80100218:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010021f:	e8 bc 43 00 00       	call   801045e0 <acquire>
  b->refcnt--;
...
8010026f:	5d                   	pop    %ebp
  release(&bcache.lock);
80100270:	e9 2b 44 00 00       	jmp    801046a0 <release>
    panic("brelse");
...
801002b1:	e8 2a 43 00 00       	call   801045e0 <acquire>
...
8010030e:	e8 8d 43 00 00       	call   801046a0 <release>
        ilock(ip);
80100313:	5a                   	pop    %edx
...
80100365:	e8 36 43 00 00       	call   801046a0 <release>
  ilock(ip);
8010036a:	58                   	pop    %eax
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 1f 7b 10 80 	movl   $0x80107b1f,(%esp)
...
801003dc:	e8 9f 40 00 00       	call   80104480 <getcallerpcs>
  for(i=0; i<10; i++)
...
8010065f:	e8 7c 3f 00 00       	call   801045e0 <acquire>
  for(i = 0; i < n; i++)
...
80100697:	e8 04 40 00 00       	call   801046a0 <release>
  ilock(ip);
8010069c:	58                   	pop    %eax
...
801007bd:	e8 1e 3e 00 00       	call   801045e0 <acquire>
...
80100828:	e8 73 3e 00 00       	call   801046a0 <release>
...
80100877:	e8 64 3d 00 00       	call   801045e0 <acquire>
  while((c = getc()) >= 0){
...
801009cf:	e8 cc 3c 00 00       	call   801046a0 <release>
  if(doprocdump) {
...
80100a44:	e8 17 3a 00 00       	call   80104460 <initlock>
...
80100b73:	e8 88 61 00 00       	call   80106d00 <allocuvm>
...
80100c32:	e8 c9 60 00 00       	call   80106d00 <allocuvm>
...
80100ca3:	e8 48 3c 00 00       	call   801048f0 <strlen>
...
80100cb6:	e8 35 3c 00 00       	call   801048f0 <strlen>
...
80100cc7:	e8 14 64 00 00       	call   801070e0 <copyout>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 a8 63 00 00       	call   801070e0 <copyout>
...
80100d71:	e8 3a 3b 00 00       	call   801048b0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100df4:	e8 67 36 00 00       	call   80104460 <initlock>
}
...
80100e15:	e8 c6 37 00 00       	call   801045e0 <acquire>
...
80100e41:	e8 5a 38 00 00       	call   801046a0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e5a:	e8 41 38 00 00       	call   801046a0 <release>
}
...
80100e83:	e8 58 37 00 00       	call   801045e0 <acquire>
  if(f->ref < 1)
...
80100ea0:	e8 fb 37 00 00       	call   801046a0 <release>
  return f;
}
...
80100ed5:	e8 06 37 00 00       	call   801045e0 <acquire>
  if(f->ref < 1)
...
80100f0d:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f10:	e8 8b 37 00 00       	call   801046a0 <release>
...
80100f3d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f3e:	e9 5d 37 00 00       	jmp    801046a0 <release>
...
80101217:	68 3f 72 10 80       	push   $0x8010723f
...
801012d4:	68 52 72 10 80       	push   $0x80107252
...
80101315:	e8 d6 33 00 00       	call   801046f0 <memset>
  log_write(bp);
...
8010135a:	e8 81 32 00 00       	call   801045e0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013c7:	e8 d4 32 00 00       	call   801046a0 <release>
...
801013f2:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801013f5:	e8 a6 32 00 00       	call   801046a0 <release>
      return ip;
...
80101422:	68 68 72 10 80       	push   $0x80107268
...
801014eb:	68 78 72 10 80       	push   $0x80107278
...
80101525:	e8 66 32 00 00       	call   80104790 <memmove>
  brelse(bp);
...
8010155a:	e8 01 2f 00 00       	call   80104460 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101577:	e8 a4 2d 00 00       	call   80104320 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010165e:	e8 8d 30 00 00       	call   801046f0 <memset>
      dip->type = type;
...
80101705:	e8 86 30 00 00       	call   80104790 <memmove>
  log_write(bp);
...
80101743:	e8 98 2e 00 00       	call   801045e0 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101753:	e8 48 2f 00 00       	call   801046a0 <release>
}
...
80101786:	e8 d5 2b 00 00       	call   80104360 <acquiresleep>
  if(ip->valid == 0){
...
801017f8:	e8 93 2f 00 00       	call   80104790 <memmove>
    brelse(bp);
...
80101857:	e8 a4 2b 00 00       	call   80104400 <holdingsleep>
...
80101872:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
80101873:	e9 48 2b 00 00       	jmp    801043c0 <releasesleep>
    panic("iunlock");
...
801018a4:	e8 b7 2a 00 00       	call   80104360 <acquiresleep>
...
801018be:	e8 fd 2a 00 00       	call   801043c0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801018ca:	e8 11 2d 00 00       	call   801045e0 <acquire>
  ip->ref--;
...
801018e3:	5d                   	pop    %ebp
  release(&icache.lock);
801018e4:	e9 b7 2d 00 00       	jmp    801046a0 <release>
801018e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    acquire(&icache.lock);
801018f0:	83 ec 0c             	sub    $0xc,%esp
801018f3:	68 e0 09 11 80       	push   $0x801109e0
801018f8:	e8 e3 2c 00 00       	call   801045e0 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101907:	e8 94 2d 00 00       	call   801046a0 <release>
    if(r == 1){
...
80101b07:	e8 84 2c 00 00       	call   80104790 <memmove>
    brelse(bp);
...
80101c03:	e8 88 2b 00 00       	call   80104790 <memmove>
    log_write(bp);
...
80101ca2:	e8 59 2b 00 00       	call   80104800 <strncmp>
}
80101ca7:	c9                   	leave  
80101ca8:	c3                   	ret    
...
80101d05:	e8 f6 2a 00 00       	call   80104800 <strncmp>
      continue;
...
80101d9c:	e8 3f 28 00 00       	call   801045e0 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101dac:	e8 ef 28 00 00       	call   801046a0 <release>
...
80101e17:	e8 74 29 00 00       	call   80104790 <memmove>
...
80101ea3:	e8 e8 28 00 00       	call   80104790 <memmove>
    name[len] = 0;
...
80101fd5:	e8 76 28 00 00       	call   80104850 <strncpy>
...
80102020:	68 06 79 10 80       	push   $0x80107906
...
80102164:	e8 f7 22 00 00       	call   80104460 <initlock>
...
801021f2:	e8 e9 23 00 00       	call   801045e0 <acquire>
...
8010226b:	e8 30 24 00 00       	call   801046a0 <release>
...
80102292:	e8 69 21 00 00       	call   80104400 <holdingsleep>
...
801022cc:	e8 0f 23 00 00       	call   801045e0 <acquire>
...
80102335:	c9                   	leave  
  release(&idelock);
80102336:	e9 65 23 00 00       	jmp    801046a0 <release>
...
801024a6:	e8 45 22 00 00       	call   801046f0 <memset>
...
801024e0:	e8 fb 20 00 00       	call   801045e0 <acquire>
...
801024fa:	c9                   	leave  
    release(&kmem.lock);
801024fb:	e9 a0 21 00 00       	jmp    801046a0 <release>
    panic("kfree");
...
80102579:	e8 e2 1e 00 00       	call   80104460 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102663:	e8 78 1f 00 00       	call   801045e0 <acquire>
  r = kmem.freelist;
...
80102691:	e8 0a 20 00 00       	call   801046a0 <release>
  return (char*)r;
...
80102abf:	e8 7c 1c 00 00       	call   80104740 <memcmp>
...
80102bf4:	e8 97 1b 00 00       	call   80104790 <memmove>
...
80102ca8:	e8 b3 17 00 00       	call   80104460 <initlock>
  readsb(dev, &sb);
80102cad:	58                   	pop    %eax
...
80102d3f:	e8 9c 18 00 00       	call   801045e0 <acquire>
...
80102d94:	e8 07 19 00 00       	call   801046a0 <release>
      break;
    }
  }
}
...
80102db2:	e8 29 18 00 00       	call   801045e0 <acquire>
  log.outstanding -= 1;
...
80102df0:	e8 ab 18 00 00       	call   801046a0 <release>
}
...
80102e0a:	e8 d1 17 00 00       	call   801045e0 <acquire>
    wakeup(&log);
...
80102e84:	e8 07 19 00 00       	call   80104790 <memmove>
...
80102ee4:	e8 b7 17 00 00       	call   801046a0 <release>
...
80102f52:	e8 89 16 00 00       	call   801045e0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f94:	c9                   	leave  
  release(&log.lock);
80102f95:	e9 06 17 00 00       	jmp    801046a0 <release>
...
80103002:	e8 a9 29 00 00       	call   801059b0 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 51 3a 00 00       	call   80106a80 <switchkvm>
  seginit();
8010302f:	e8 bc 39 00 00       	call   801069f0 <seginit>
  lapicinit();
...
80103074:	e8 77 39 00 00       	call   801069f0 <seginit>
  picinit();       // disable pic
...
80103088:	e8 23 2c 00 00       	call   80105cb0 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 99 28 00 00       	call   80105930 <tvinit>
  binit();         // buffer cache
...
801030b8:	e8 d3 16 00 00       	call   80104790 <memmove>
...
801031a4:	e8 97 15 00 00       	call   80104740 <memcmp>
...
80103260:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103263:	e8 d8 14 00 00       	call   80104740 <memcmp>
...
8010346d:	e8 ee 0f 00 00       	call   80104460 <initlock>
  (*f0)->type = FD_PIPE;
...
80103513:	e8 c8 10 00 00       	call   801045e0 <acquire>
  if(writable){
...
80103557:	5d                   	pop    %ebp
    release(&p->lock);
80103558:	e9 43 11 00 00       	jmp    801046a0 <release>
...
80103584:	e8 17 11 00 00       	call   801046a0 <release>
    kfree((char*)p);
...
8010363c:	e8 5f 10 00 00       	call   801046a0 <release>
        return -1;
...
80103692:	e8 09 10 00 00       	call   801046a0 <release>
  return n;
...
801036ba:	e8 21 0f 00 00       	call   801045e0 <acquire>
...
8010375e:	e8 3d 0f 00 00       	call   801046a0 <release>
  return i;
...
80103779:	e8 22 0f 00 00       	call   801046a0 <release>
      return -1;
...
801037a1:	e8 3a 0e 00 00       	call   801045e0 <acquire>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 21 59 10 80 	movl   $0x80105921,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 d5 0e 00 00       	call   801046f0 <memset>
...
8010383a:	e8 61 0e 00 00       	call   801046a0 <release>
}
...
8010386f:	e8 2c 0e 00 00       	call   801046a0 <release>
...
801038ba:	68 c0 76 10 80       	push   $0x801076c0
801038bf:	68 20 2d 11 80       	push   $0x80112d20
801038c4:	e8 97 0b 00 00       	call   80104460 <initlock>
}
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 70 0b 00 00       	call   801044e0 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 b0 0b 00 00       	call   80104530 <popcli>
}
...
801039a7:	e8 34 35 00 00       	call   80106ee0 <setupkvm>
...
801039c5:	e8 e6 31 00 00       	call   80106bb0 <inituvm>
...
801039da:	e8 11 0d 00 00       	call   801046f0 <memset>
...
80103a33:	68 f0 76 10 80       	push   $0x801076f0
80103a38:	50                   	push   %eax
80103a39:	e8 72 0e 00 00       	call   801048b0 <safestrcpy>
  p->cwd = namei("/");
80103a3e:	c7 04 24 f9 76 10 80 	movl   $0x801076f9,(%esp)
...
80103a77:	68 d7 76 10 80       	push   $0x801076d7
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 3f 0a 00 00       	call   801044e0 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 7f 0a 00 00       	call   80104530 <popcli>
  sz = curproc->sz;
...
80103abf:	e8 dc 2f 00 00       	call   80106aa0 <switchuvm>
  return 0;
...
80103ada:	e8 21 32 00 00       	call   80106d00 <allocuvm>
...
80103afa:	e8 31 33 00 00       	call   80106e30 <deallocuvm>
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 be 09 00 00       	call   801044e0 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 fe 09 00 00       	call   80104530 <popcli>
  if((np = allocproc()) == 0){
...
80103b4c:	e8 5f 34 00 00       	call   80106fb0 <copyuvm>
...
80103c66:	e8 75 09 00 00       	call   801045e0 <acquire>
...
80103c80:	e8 1b 2e 00 00       	call   80106aa0 <switchuvm>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 7c 0c 00 00       	call   80104913 <swtch>
      switchkvm();
80103c97:	e8 e4 2d 00 00       	call   80106a80 <switchkvm>
      c->proc = 0;
...
80103d37:	e8 d7 0b 00 00       	call   80104913 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 3e 07 00 00       	call   801044e0 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 7e 07 00 00       	call   80104530 <popcli>
  if(curproc == initproc)
...
80103e0a:	e8 d1 07 00 00       	call   801045e0 <acquire>
...
80103ead:	68 48 77 10 80       	push   $0x80107748
80103eb2:	e8 d9 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 3b 77 10 80       	push   $0x8010773b
...
80103ee0:	e8 fb 06 00 00       	call   801045e0 <acquire>
  pushcli();
80103ee5:	e8 f6 05 00 00       	call   801044e0 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 36 06 00 00       	call   80104530 <popcli>
...
80103f0d:	e8 8e 07 00 00       	call   801046a0 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 a8 05 00 00       	call   801044e0 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 e8 05 00 00       	call   80104530 <popcli>
  if(p == 0)
...
80103f64:	e8 77 06 00 00       	call   801045e0 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 2f 07 00 00       	call   801046a0 <release>
  p->chan = chan;
...
80103f8e:	e8 0d 07 00 00       	call   801046a0 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 3b 06 00 00       	jmp    801045e0 <acquire>
...
80103fc9:	68 5a 77 10 80       	push   $0x8010775a
80103fce:	e8 bd c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fd3:	83 ec 0c             	sub    $0xc,%esp
80103fd6:	68 54 77 10 80       	push   $0x80107754
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 da 2d 00 00       	call   80106e60 <freevm>
        release(&ptable.lock);
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 ee 05 00 00       	call   801046a0 <release>
        return pid;
...
801040cb:	e8 d0 05 00 00       	call   801046a0 <release>
      return -1;
...
801040f3:	e8 e8 04 00 00       	call   801045e0 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 62 05 00 00       	jmp    801046a0 <release>
...
80104153:	e8 88 04 00 00       	call   801045e0 <acquire>
...
801041b0:	e8 eb 04 00 00       	call   801046a0 <release>
}
...
801041f3:	68 1f 7b 10 80       	push   $0x80107b1f
...
80104214:	74 ea                	je     80104200 <procdump+0x30>
      state = "???";
80104216:	ba 6b 77 10 80       	mov    $0x8010776b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010421b:	83 f8 05             	cmp    $0x5,%eax
8010421e:	77 11                	ja     80104231 <procdump+0x61>
80104220:	8b 14 85 00 78 10 80 	mov    -0x7fef8800(,%eax,4),%edx
      state = "???";
80104227:	b8 6b 77 10 80       	mov    $0x8010776b,%eax
...
80104236:	68 6f 77 10 80       	push   $0x8010776f
...
8010425d:	e8 1e 02 00 00       	call   80104480 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104275:	68 c1 71 10 80       	push   $0x801071c1
...
8010432e:	68 18 78 10 80       	push   $0x80107818
80104333:	8d 43 04             	lea    0x4(%ebx),%eax
80104336:	50                   	push   %eax
80104337:	e8 24 01 00 00       	call   80104460 <initlock>
  lk->name = name;
...
80104345:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104348:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  lk->name = name;
...
80104373:	e8 68 02 00 00       	call   801045e0 <acquire>
  while (lk->locked) {
80104378:	8b 13                	mov    (%ebx),%edx
8010437a:	83 c4 10             	add    $0x10,%esp
8010437d:	85 d2                	test   %edx,%edx
8010437f:	74 1a                	je     8010439b <acquiresleep+0x3b>
80104381:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    sleep(lk, &lk->lk);
80104388:	83 ec 08             	sub    $0x8,%esp
8010438b:	56                   	push   %esi
8010438c:	53                   	push   %ebx
8010438d:	e8 8e fb ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
80104392:	8b 03                	mov    (%ebx),%eax
80104394:	83 c4 10             	add    $0x10,%esp
80104397:	85 c0                	test   %eax,%eax
80104399:	75 ed                	jne    80104388 <acquiresleep+0x28>
  }
  lk->locked = 1;
8010439b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801043a1:	e8 ba f5 ff ff       	call   80103960 <myproc>
801043a6:	8b 40 10             	mov    0x10(%eax),%eax
...
801043b4:	5d                   	pop    %ebp
  release(&lk->lk);
801043b5:	e9 e6 02 00 00       	jmp    801046a0 <release>
...
801043c9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801043cc:	8d 73 04             	lea    0x4(%ebx),%esi
801043cf:	83 ec 0c             	sub    $0xc,%esp
801043d2:	56                   	push   %esi
801043d3:	e8 08 02 00 00       	call   801045e0 <acquire>
  lk->locked = 0;
801043d8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801043de:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
801043e5:	89 1c 24             	mov    %ebx,(%esp)
801043e8:	e8 f3 fc ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
801043ed:	89 75 08             	mov    %esi,0x8(%ebp)
...
801043f8:	5d                   	pop    %ebp
  release(&lk->lk);
801043f9:	e9 a2 02 00 00       	jmp    801046a0 <release>
...
80104408:	31 ff                	xor    %edi,%edi
8010440a:	56                   	push   %esi
8010440b:	53                   	push   %ebx
8010440c:	83 ec 18             	sub    $0x18,%esp
8010440f:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int r;
  
  acquire(&lk->lk);
80104412:	8d 73 04             	lea    0x4(%ebx),%esi
80104415:	56                   	push   %esi
80104416:	e8 c5 01 00 00       	call   801045e0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
8010441b:	8b 03                	mov    (%ebx),%eax
8010441d:	83 c4 10             	add    $0x10,%esp
80104420:	85 c0                	test   %eax,%eax
80104422:	75 1c                	jne    80104440 <holdingsleep+0x40>
  release(&lk->lk);
80104424:	83 ec 0c             	sub    $0xc,%esp
80104427:	56                   	push   %esi
80104428:	e8 73 02 00 00       	call   801046a0 <release>
  return r;
}
8010442d:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104430:	89 f8                	mov    %edi,%eax
80104432:	5b                   	pop    %ebx
80104433:	5e                   	pop    %esi
80104434:	5f                   	pop    %edi
80104435:	5d                   	pop    %ebp
...
80104467:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
8010446a:	8b 55 0c             	mov    0xc(%ebp),%edx
  lk->locked = 0;
8010446d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->name = name;
80104473:	89 50 04             	mov    %edx,0x4(%eax)
  lk->cpu = 0;
80104476:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
8010447d:	5d                   	pop    %ebp
8010447e:	c3                   	ret    
8010447f:	90                   	nop
...
{
8010448d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  ebp = (uint*)v - 2;
80104490:	83 e8 08             	sub    $0x8,%eax
  for(i = 0; i < 10; i++){
...
801044a4:	77 1a                	ja     801044c0 <getcallerpcs+0x40>
      break;
...
801044b4:	75 e2                	jne    80104498 <getcallerpcs+0x18>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
801044c3:	8d 51 28             	lea    0x28(%ecx),%edx
...
801044ed:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044ee:	e8 dd f3 ff ff       	call   801038d0 <mycpu>
801044f3:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801044f9:	85 c0                	test   %eax,%eax
801044fb:	74 13                	je     80104510 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801044fd:	e8 ce f3 ff ff       	call   801038d0 <mycpu>
80104502:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104521:	eb da                	jmp    801044fd <pushcli+0x1d>
...
8010453b:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010453c:	f6 c4 02             	test   $0x2,%ah
8010453f:	75 31                	jne    80104572 <popcli+0x42>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80104541:	e8 8a f3 ff ff       	call   801038d0 <mycpu>
80104546:	83 a8 a4 00 00 00 01 	subl   $0x1,0xa4(%eax)
8010454d:	78 30                	js     8010457f <popcli+0x4f>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
8010454f:	e8 7c f3 ff ff       	call   801038d0 <mycpu>
80104554:	8b 90 a4 00 00 00    	mov    0xa4(%eax),%edx
8010455a:	85 d2                	test   %edx,%edx
8010455c:	74 02                	je     80104560 <popcli+0x30>
    sti();
}
8010455e:	c9                   	leave  
8010455f:	c3                   	ret    
...
8010456d:	74 ef                	je     8010455e <popcli+0x2e>
  asm volatile("sti");
8010456f:	fb                   	sti    
}
80104570:	c9                   	leave  
...
80104575:	68 23 78 10 80       	push   $0x80107823
8010457a:	e8 11 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010457f:	83 ec 0c             	sub    $0xc,%esp
80104582:	68 3a 78 10 80       	push   $0x8010783a
...
8010459c:	31 db                	xor    %ebx,%ebx
  pushcli();
8010459e:	e8 3d ff ff ff       	call   801044e0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801045a3:	8b 06                	mov    (%esi),%eax
801045a5:	85 c0                	test   %eax,%eax
801045a7:	75 0f                	jne    801045b8 <holding+0x28>
  popcli();
801045a9:	e8 82 ff ff ff       	call   80104530 <popcli>
}
801045ae:	89 d8                	mov    %ebx,%eax
801045b0:	5b                   	pop    %ebx
801045b1:	5e                   	pop    %esi
801045b2:	5d                   	pop    %ebp
801045b3:	c3                   	ret    
801045b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  r = lock->locked && lock->cpu == mycpu();
801045b8:	8b 5e 08             	mov    0x8(%esi),%ebx
801045bb:	e8 10 f3 ff ff       	call   801038d0 <mycpu>
801045c0:	39 c3                	cmp    %eax,%ebx
801045c2:	0f 94 c3             	sete   %bl
  popcli();
801045c5:	e8 66 ff ff ff       	call   80104530 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801045ca:	0f b6 db             	movzbl %bl,%ebx
}
...
801045e9:	e8 f2 fe ff ff       	call   801044e0 <pushcli>
  if(holding(lk))
801045ee:	8b 5d 08             	mov    0x8(%ebp),%ebx
801045f1:	83 ec 0c             	sub    $0xc,%esp
801045f4:	53                   	push   %ebx
801045f5:	e8 96 ff ff ff       	call   80104590 <holding>
801045fa:	83 c4 10             	add    $0x10,%esp
801045fd:	85 c0                	test   %eax,%eax
801045ff:	0f 85 7f 00 00 00    	jne    80104684 <acquire+0xa4>
80104605:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80104607:	ba 01 00 00 00       	mov    $0x1,%edx
8010460c:	eb 05                	jmp    80104613 <acquire+0x33>
...
80104624:	e8 a7 f2 ff ff       	call   801038d0 <mycpu>
80104629:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
8010462c:	89 e8                	mov    %ebp,%eax
8010462e:	66 90                	xchg   %ax,%ax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104630:	8d 90 00 00 00 80    	lea    -0x80000000(%eax),%edx
80104636:	81 fa fe ff ff 7f    	cmp    $0x7ffffffe,%edx
8010463c:	77 22                	ja     80104660 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
8010463e:	8b 50 04             	mov    0x4(%eax),%edx
80104641:	89 54 b3 0c          	mov    %edx,0xc(%ebx,%esi,4)
  for(i = 0; i < 10; i++){
80104645:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
80104648:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
8010464a:	83 fe 0a             	cmp    $0xa,%esi
...
8010465d:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104660:	8d 44 b3 0c          	lea    0xc(%ebx,%esi,4),%eax
80104664:	83 c3 34             	add    $0x34,%ebx
...
80104687:	68 41 78 10 80       	push   $0x80107841
...
801046a8:	83 ec 10             	sub    $0x10,%esp
801046ab:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(!holding(lk))
801046ae:	53                   	push   %ebx
801046af:	e8 dc fe ff ff       	call   80104590 <holding>
801046b4:	83 c4 10             	add    $0x10,%esp
801046b7:	85 c0                	test   %eax,%eax
801046b9:	74 22                	je     801046dd <release+0x3d>
  lk->pcs[0] = 0;
801046bb:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801046c2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801046c9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801046ce:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801046d4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801046d7:	c9                   	leave  
  popcli();
801046d8:	e9 53 fe ff ff       	jmp    80104530 <popcli>
    panic("release");
801046dd:	83 ec 0c             	sub    $0xc,%esp
801046e0:	68 49 78 10 80       	push   $0x80107849
...
80104704:	09 cf                	or     %ecx,%edi
80104706:	83 e7 03             	and    $0x3,%edi
80104709:	75 25                	jne    80104730 <memset+0x40>
    c &= 0xFF;
8010470b:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010470e:	c1 e0 18             	shl    $0x18,%eax
80104711:	89 fb                	mov    %edi,%ebx
80104713:	c1 e9 02             	shr    $0x2,%ecx
...
80104748:	8b 75 10             	mov    0x10(%ebp),%esi
...
80104754:	74 2a                	je     80104780 <memcmp+0x40>
80104756:	01 c6                	add    %eax,%esi
80104758:	eb 10                	jmp    8010476a <memcmp+0x2a>
...
8010479f:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801047a2:	39 d6                	cmp    %edx,%esi
801047a4:	73 2a                	jae    801047d0 <memmove+0x40>
801047a6:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
801047a9:	39 fa                	cmp    %edi,%edx
801047ab:	73 23                	jae    801047d0 <memmove+0x40>
801047ad:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
801047b0:	85 c9                	test   %ecx,%ecx
801047b2:	74 13                	je     801047c7 <memmove+0x37>
801047b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      *--d = *--s;
801047b8:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801047bc:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
801047bf:	83 e8 01             	sub    $0x1,%eax
801047c2:	83 f8 ff             	cmp    $0xffffffff,%eax
...
801047cd:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
801047d0:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
801047d3:	89 d7                	mov    %edx,%edi
801047d5:	85 c9                	test   %ecx,%ecx
801047d7:	74 ee                	je     801047c7 <memmove+0x37>
801047d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801047e0:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801047e1:	39 f0                	cmp    %esi,%eax
801047e3:	75 fb                	jne    801047e0 <memmove+0x50>
}
801047e5:	5e                   	pop    %esi
...
80104808:	8b 75 10             	mov    0x10(%ebp),%esi
8010480b:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010480e:	53                   	push   %ebx
8010480f:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80104812:	85 f6                	test   %esi,%esi
80104814:	74 32                	je     80104848 <strncmp+0x48>
80104816:	01 c6                	add    %eax,%esi
80104818:	eb 14                	jmp    8010482e <strncmp+0x2e>
8010481a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104820:	38 da                	cmp    %bl,%dl
80104822:	75 14                	jne    80104838 <strncmp+0x38>
    n--, p++, q++;
80104824:	83 c0 01             	add    $0x1,%eax
80104827:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010482a:	39 f0                	cmp    %esi,%eax
8010482c:	74 1a                	je     80104848 <strncmp+0x48>
8010482e:	0f b6 11             	movzbl (%ecx),%edx
80104831:	0f b6 18             	movzbl (%eax),%ebx
80104834:	84 d2                	test   %dl,%dl
80104836:	75 e8                	jne    80104820 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104838:	0f b6 c2             	movzbl %dl,%eax
8010483b:	29 d8                	sub    %ebx,%eax
}
8010483d:	5b                   	pop    %ebx
8010483e:	5e                   	pop    %esi
8010483f:	5d                   	pop    %ebp
...
8010485d:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104860:	89 f2                	mov    %esi,%edx
80104862:	eb 1b                	jmp    8010487f <strncpy+0x2f>
80104864:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104868:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010486c:	8b 7d 0c             	mov    0xc(%ebp),%edi
8010486f:	83 c2 01             	add    $0x1,%edx
80104872:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
80104876:	89 f9                	mov    %edi,%ecx
80104878:	88 4a ff             	mov    %cl,-0x1(%edx)
8010487b:	84 c9                	test   %cl,%cl
8010487d:	74 09                	je     80104888 <strncpy+0x38>
8010487f:	89 c3                	mov    %eax,%ebx
80104881:	83 e8 01             	sub    $0x1,%eax
80104884:	85 db                	test   %ebx,%ebx
80104886:	7f e0                	jg     80104868 <strncpy+0x18>
    ;
  while(n-- > 0)
80104888:	89 d1                	mov    %edx,%ecx
8010488a:	85 c0                	test   %eax,%eax
8010488c:	7e 15                	jle    801048a3 <strncpy+0x53>
8010488e:	66 90                	xchg   %ax,%ax
    *s++ = 0;
80104890:	83 c1 01             	add    $0x1,%ecx
80104893:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
80104897:	89 c8                	mov    %ecx,%eax
80104899:	f7 d0                	not    %eax
8010489b:	01 d0                	add    %edx,%eax
8010489d:	01 d8                	add    %ebx,%eax
8010489f:	85 c0                	test   %eax,%eax
801048a1:	7f ed                	jg     80104890 <strncpy+0x40>
  return os;
}
801048a3:	5b                   	pop    %ebx
801048a4:	89 f0                	mov    %esi,%eax
801048a6:	5e                   	pop    %esi
801048a7:	5f                   	pop    %edi
801048a8:	5d                   	pop    %ebp
801048a9:	c3                   	ret    
...
801048b8:	8b 55 10             	mov    0x10(%ebp),%edx
801048bb:	8b 75 08             	mov    0x8(%ebp),%esi
...
801048c4:	7e 21                	jle    801048e7 <safestrcpy+0x37>
801048c6:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801048ca:	89 f2                	mov    %esi,%edx
801048cc:	eb 12                	jmp    801048e0 <safestrcpy+0x30>
...
801048f9:	8b 55 08             	mov    0x8(%ebp),%edx
  for(n = 0; s[n]; n++)
801048fc:	80 3a 00             	cmpb   $0x0,(%edx)
801048ff:	74 10                	je     80104911 <strlen+0x21>
80104901:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104908:	83 c0 01             	add    $0x1,%eax
8010490b:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
8010490f:	75 f7                	jne    80104908 <strlen+0x18>
    ;
  return n;
}
80104911:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80104913:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104917:	8b 54 24 08          	mov    0x8(%esp),%edx
...
8010491e:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
8010491f:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80104921:	89 d4                	mov    %edx,%esp
...
8010493b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010493e:	e8 1d f0 ff ff       	call   80103960 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104943:	8b 00                	mov    (%eax),%eax
80104945:	39 d8                	cmp    %ebx,%eax
80104947:	76 17                	jbe    80104960 <fetchint+0x30>
80104949:	8d 53 04             	lea    0x4(%ebx),%edx
8010494c:	39 d0                	cmp    %edx,%eax
8010494e:	72 10                	jb     80104960 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
80104950:	8b 45 0c             	mov    0xc(%ebp),%eax
80104953:	8b 13                	mov    (%ebx),%edx
80104955:	89 10                	mov    %edx,(%eax)
  return 0;
80104957:	31 c0                	xor    %eax,%eax
}
...
80104965:	eb f2                	jmp    80104959 <fetchint+0x29>
...
8010497e:	e8 dd ef ff ff       	call   80103960 <myproc>
  ...
  if(addr >= curproc->sz)
80104983:	39 18                	cmp    %ebx,(%eax)
80104985:	76 31                	jbe    801049b8 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
80104987:	8b 55 0c             	mov    0xc(%ebp),%edx
8010498a:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
8010498c:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010498e:	39 d3                	cmp    %edx,%ebx
80104990:	73 26                	jae    801049b8 <fetchstr+0x48>
80104992:	89 d8                	mov    %ebx,%eax
80104994:	eb 11                	jmp    801049a7 <fetchstr+0x37>
80104996:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010499d:	8d 76 00             	lea    0x0(%esi),%esi
801049a0:	83 c0 01             	add    $0x1,%eax
801049a3:	39 c2                	cmp    %eax,%edx
801049a5:	76 11                	jbe    801049b8 <fetchstr+0x48>
    if(*s == 0)
801049a7:	80 38 00             	cmpb   $0x0,(%eax)
801049aa:	75 f4                	jne    801049a0 <fetchstr+0x30>
      return s - *pp;
  }
  return -1;
}
801049ac:	83 c4 04             	add    $0x4,%esp
      return s - *pp;
801049af:	29 d8                	sub    %ebx,%eax
}
801049b1:	5b                   	pop    %ebx
801049b2:	5d                   	pop    %ebp
801049b3:	c3                   	ret    
801049b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801049b8:	83 c4 04             	add    $0x4,%esp
    return -1;
...
801049d9:	e8 82 ef ff ff       	call   80103960 <myproc>
801049de:	8b 55 08             	mov    0x8(%ebp),%edx
801049e1:	8b 40 18             	mov    0x18(%eax),%eax
801049e4:	8b 40 44             	mov    0x44(%eax),%eax
801049e7:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049ea:	e8 71 ef ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049ef:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
801049f2:	8b 00                	mov    (%eax),%eax
801049f4:	39 c6                	cmp    %eax,%esi
801049f6:	73 18                	jae    80104a10 <argint+0x40>
801049f8:	8d 53 08             	lea    0x8(%ebx),%edx
801049fb:	39 d0                	cmp    %edx,%eax
801049fd:	72 11                	jb     80104a10 <argint+0x40>
  *ip = *(int*)(addr);
801049ff:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a02:	8b 53 04             	mov    0x4(%ebx),%edx
...
80104a10:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a15:	eb f2                	jmp    80104a09 <argint+0x39>
...
80104a29:	83 ec 10             	sub    $0x10,%esp
80104a2c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a2f:	e8 2c ef ff ff       	call   80103960 <myproc>
...
80104a3d:	ff 75 08             	pushl  0x8(%ebp)
80104a40:	e8 8b ff ff ff       	call   801049d0 <argint>
    return -1;
...
80104a75:	eb ef                	jmp    80104a66 <argptr+0x46>
...
80104a87:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80104a8a:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104a8d:	50                   	push   %eax
80104a8e:	ff 75 08             	pushl  0x8(%ebp)
80104a91:	e8 3a ff ff ff       	call   801049d0 <argint>
80104a96:	83 c4 10             	add    $0x10,%esp
80104a99:	85 c0                	test   %eax,%eax
80104a9b:	78 13                	js     80104ab0 <argstr+0x30>
    return -1;
  return fetchstr(addr, pp);
80104a9d:	83 ec 08             	sub    $0x8,%esp
80104aa0:	ff 75 0c             	pushl  0xc(%ebp)
80104aa3:	ff 75 f4             	pushl  -0xc(%ebp)
80104aa6:	e8 c5 fe ff ff       	call   80104970 <fetchstr>
...
80104ac8:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104acb:	e8 90 ee ff ff       	call   80103960 <myproc>
...
80104adb:	83 fa 16             	cmp    $0x16,%edx
80104ade:	77 20                	ja     80104b00 <syscall+0x40>
80104ae0:	8b 14 85 80 78 10 80 	mov    -0x7fef8780(,%eax,4),%edx
...
80104b08:	68 51 78 10 80       	push   $0x80107851
...
80104b47:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b4a:	e8 01 d5 ff ff       	call   80102050 <nameiparent>
...
80104b60:	e8 fb cb ff ff       	call   80101760 <ilock>
...
80104b6c:	e8 3f d1 ff ff       	call   80101cb0 <dirlookup>
...
80104b7e:	e8 7d ce ff ff       	call   80101a00 <iunlockput>
    ilock(ip);
80104b83:	89 34 24             	mov    %esi,(%esp)
80104b86:	e8 d5 cb ff ff       	call   80101760 <ilock>
...
80104bb4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104bb6:	e8 45 ce ff ff       	call   80101a00 <iunlockput>
    return 0;
...
80104bda:	e8 01 ca ff ff       	call   801015e0 <ialloc>
...
80104c11:	e8 8a ca ff ff       	call   801016a0 <iupdate>
...
80104c28:	e8 43 d3 ff ff       	call   80101f70 <dirlink>
...
80104c38:	e8 c3 cd ff ff       	call   80101a00 <iunlockput>
  return ip;
...
80104c59:	e8 42 ca ff ff       	call   801016a0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c5e:	83 c4 0c             	add    $0xc,%esp
80104c61:	ff 76 04             	pushl  0x4(%esi)
80104c64:	68 fc 78 10 80       	push   $0x801078fc
80104c69:	56                   	push   %esi
80104c6a:	e8 01 d3 ff ff       	call   80101f70 <dirlink>
...
80104c7c:	68 fb 78 10 80       	push   $0x801078fb
80104c81:	56                   	push   %esi
80104c82:	e8 e9 d2 ff ff       	call   80101f70 <dirlink>
...
80104c91:	68 ef 78 10 80       	push   $0x801078ef
...
80104caf:	68 fe 78 10 80       	push   $0x801078fe
80104cb4:	e8 d7 b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104cb9:	83 ec 0c             	sub    $0xc,%esp
80104cbc:	68 e0 78 10 80       	push   $0x801078e0
...
80104cf4:	e8 67 ec ff ff       	call   80103960 <myproc>
...
80104d3d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d3f:	e8 1c ec ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104d7a:	e8 f1 c0 ff ff       	call   80100e70 <filedup>
  return fd;
...
80104dc9:	e8 52 fc ff ff       	call   80104a20 <argptr>
...
80104de1:	e8 0a c2 ff ff       	call   80100ff0 <fileread>
...
80104e39:	e8 e2 fb ff ff       	call   80104a20 <argptr>
...
80104e51:	e8 3a c2 ff ff       	call   80101090 <filewrite>
...
80104e87:	78 27                	js     80104eb0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e89:	e8 d2 ea ff ff       	call   80103960 <myproc>
...
80104e9f:	e8 1c c0 ff ff       	call   80100ec0 <fileclose>
  return 0;
...
80104ee3:	e8 38 fb ff ff       	call   80104a20 <argptr>
...
80104ef8:	e8 a3 c0 ff ff       	call   80100fa0 <filestat>
...
80104f23:	e8 58 fb ff ff       	call   80104a80 <argstr>
...
80104f6d:	e8 ee c7 ff ff       	call   80101760 <ilock>
  if(ip->type == T_DIR){
...
80104f8c:	e8 0f c7 ff ff       	call   801016a0 <iupdate>
  iunlock(ip);
80104f91:	89 1c 24             	mov    %ebx,(%esp)
80104f94:	e8 a7 c8 ff ff       	call   80101840 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104f99:	58                   	pop    %eax
80104f9a:	5a                   	pop    %edx
80104f9b:	57                   	push   %edi
80104f9c:	ff 75 d0             	pushl  -0x30(%ebp)
80104f9f:	e8 ac d0 ff ff       	call   80102050 <nameiparent>
...
80104fb1:	e8 aa c7 ff ff       	call   80101760 <ilock>
...
80104fc7:	e8 a4 cf ff ff       	call   80101f70 <dirlink>
...
80104fd7:	e8 24 ca ff ff       	call   80101a00 <iunlockput>
  iput(ip);
80104fdc:	89 1c 24             	mov    %ebx,(%esp)
80104fdf:	e8 ac c8 ff ff       	call   80101890 <iput>
  end_op();
80104fe4:	e8 b7 dd ff ff       	call   80102da0 <end_op>
  return 0;
...
80105004:	e8 f7 c9 ff ff       	call   80101a00 <iunlockput>
    goto bad;
80105009:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
8010500c:	83 ec 0c             	sub    $0xc,%esp
8010500f:	53                   	push   %ebx
80105010:	e8 4b c7 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80105015:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010501a:	89 1c 24             	mov    %ebx,(%esp)
8010501d:	e8 7e c6 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105022:	89 1c 24             	mov    %ebx,(%esp)
80105025:	e8 d6 c9 ff ff       	call   80101a00 <iunlockput>
  end_op();
8010502a:	e8 71 dd ff ff       	call   80102da0 <end_op>
  return -1;
...
8010503d:	e8 be c9 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105042:	e8 59 dd ff ff       	call   80102da0 <end_op>
    return -1;
80105047:	83 c4 10             	add    $0x10,%esp
8010504a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010504f:	eb 9d                	jmp    80104fee <sys_link+0xde>
    end_op();
80105051:	e8 4a dd ff ff       	call   80102da0 <end_op>
    return -1;
...
801050a8:	e8 b3 c6 ff ff       	call   80101760 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801050ad:	58                   	pop    %eax
801050ae:	5a                   	pop    %edx
801050af:	68 fc 78 10 80       	push   $0x801078fc
801050b4:	53                   	push   %ebx
801050b5:	e8 d6 cb ff ff       	call   80101c90 <namecmp>
...
801050c8:	68 fb 78 10 80       	push   $0x801078fb
801050cd:	53                   	push   %ebx
801050ce:	e8 bd cb ff ff       	call   80101c90 <namecmp>
...
801050e7:	e8 c4 cb ff ff       	call   80101cb0 <dirlookup>
...
801050fd:	e8 5e c6 ff ff       	call   80101760 <ilock>
  if(ip->nlink < 1)
...
8010512e:	e8 2d ca ff ff       	call   80101b60 <writei>
...
8010515b:	e8 40 c5 ff ff       	call   801016a0 <iupdate>
  iunlockput(ip);
80105160:	89 1c 24             	mov    %ebx,(%esp)
80105163:	e8 98 c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105168:	e8 33 dc ff ff       	call   80102da0 <end_op>
  return 0;
...
801051a0:	e8 bb c8 ff ff       	call   80101a60 <readi>
...
801051bb:	e8 40 c8 ff ff       	call   80101a00 <iunlockput>
    goto bad;
...
801051cc:	e8 2f c8 ff ff       	call   80101a00 <iunlockput>
  end_op();
...
801051e9:	e8 b2 c4 ff ff       	call   801016a0 <iupdate>
...
80105253:	e8 28 f8 ff ff       	call   80104a80 <argstr>
...
80105276:	78 75                	js     801052ed <sys_open+0xad>
  ...
  begin_op();
80105278:	e8 b3 da ff ff       	call   80102d30 <begin_op>
...
80105289:	e8 a2 cd ff ff       	call   80102030 <namei>
...
8010529b:	e8 c0 c4 ff ff       	call   80101760 <ilock>
...
801052b7:	74 23                	je     801052dc <sys_open+0x9c>
  struct proc *curproc = myproc();
801052b9:	e8 a2 e6 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801052e0:	e8 1b c7 ff ff       	call   80101a00 <iunlockput>
    end_op();
...
80105330:	e8 0b c5 ff ff       	call   80101840 <iunlock>
  end_op();
...
80105398:	e8 e3 f6 ff ff       	call   80104a80 <argstr>
...
80105462:	e8 99 c5 ff ff       	call   80101a00 <iunlockput>
  end_op();
80105467:	e8 34 d9 ff ff       	call   80102da0 <end_op>
  return 0;
...
801054c3:	e8 68 cb ff ff       	call   80102030 <namei>
...
801054d5:	e8 86 c2 ff ff       	call   80101760 <ilock>
  if(ip->type != T_DIR){
...
801054e8:	e8 53 c3 ff ff       	call   80101840 <iunlock>
  iput(curproc->cwd);
801054ed:	58                   	pop    %eax
801054ee:	ff 76 68             	pushl  0x68(%esi)
801054f1:	e8 9a c3 ff ff       	call   80101890 <iput>
  end_op();
801054f6:	e8 a5 d8 ff ff       	call   80102da0 <end_op>
  curproc->cwd = ip;
...
80105514:	e8 e7 c4 ff ff       	call   80101a00 <iunlockput>
    end_op();
80105519:	e8 82 d8 ff ff       	call   80102da0 <end_op>
    return -1;
...
8010552f:	90                   	nop
    end_op();
80105530:	e8 6b d8 ff ff       	call   80102da0 <end_op>
    return -1;
...
80105559:	e8 22 f5 ff ff       	call   80104a80 <argstr>
...
8010559a:	e8 51 f1 ff ff       	call   801046f0 <memset>
...
801055bc:	e8 6f f3 ff ff       	call   80104930 <fetchint>
...
801055e0:	e8 8b f3 ff ff       	call   80104970 <fetchstr>
...
80105655:	e8 c6 f3 ff ff       	call   80104a20 <argptr>
...
8010566c:	e8 7f dd ff ff       	call   801033f0 <pipealloc>
...
8010567b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010567d:	e8 de e2 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010569e:	e8 1d b8 ff ff       	call   80100ec0 <fileclose>
    fileclose(wf);
801056a3:	58                   	pop    %eax
801056a4:	ff 75 e4             	pushl  -0x1c(%ebp)
801056a7:	e8 14 b8 ff ff       	call   80100ec0 <fileclose>
    return -1;
...
801056c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056ca:	e8 91 e2 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056e6:	75 f0                	jne    801056d8 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
801056e8:	e8 73 e2 ff ff       	call   80103960 <myproc>
...
80105720:	f3 0f 1e fb          	endbr32 
  return fork();
80105724:	e9 e7 e3 ff ff       	jmp    80103b10 <fork>
...
80105737:	83 ec 08             	sub    $0x8,%esp
  exit();
8010573a:	e8 51 e6 ff ff       	call   80103d90 <exit>
...
80105750:	f3 0f 1e fb          	endbr32 
  return wait();
80105754:	e9 87 e8 ff ff       	jmp    80103fe0 <wait>
...
80105782:	e8 b9 e9 ff ff       	call   80104140 <kill>
...
801057db:	78 23                	js     80105800 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057dd:	e8 7e e1 ff ff       	call   80103960 <myproc>
  if(growproc(n) < 0)
...
801057ea:	e8 a1 e2 ff ff       	call   80103a90 <growproc>
...
80105834:	68 60 4c 11 80       	push   $0x80114c60
80105839:	e8 a2 ed ff ff       	call   801045e0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010583e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105841:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105858:	68 a0 54 11 80       	push   $0x801154a0
8010585d:	e8 be e6 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
80105862:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
8010586f:	73 2f                	jae    801058a0 <sys_sleep+0x90>
    if(myproc()->killed){
80105871:	e8 ea e0 ff ff       	call   80103960 <myproc>
...
80105880:	68 60 4c 11 80       	push   $0x80114c60
...
801058c8:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058cb:	68 60 4c 11 80       	push   $0x80114c60
801058d0:	e8 0b ed ff ff       	call   801045e0 <acquire>
  xticks = ticks;
801058d5:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801058db:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801058e2:	e8 b9 ed ff ff       	call   801046a0 <release>
  return xticks;
}
...
801058f0:	f3 0f 1e fb          	endbr32 
  return getHello();
801058f4:	e9 a7 e9 ff ff       	jmp    801042a0 <getHello>
801058f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105900 <sys_getProcCount>:
}
...
80105900:	f3 0f 1e fb          	endbr32 
  return getProcCount();
80105904:	e9 b7 e9 ff ff       	jmp    801042c0 <getProcCount>
...
8010590a:	06                   	push   %es
  pushl %fs
8010590b:	0f a0                	push   %fs
  pushl %gs
8010590d:	0f a8                	push   %gs
  pushal
8010590f:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105910:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105914:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105916:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105918:	54                   	push   %esp
  call trap
80105919:	e8 c2 00 00 00       	call   801059e0 <trap>
  addl $4, %esp
8010591e:	83 c4 04             	add    $0x4,%esp
...
80105921:	61                   	popa   
  popl %gs
80105922:	0f a9                	pop    %gs
  popl %fs
80105924:	0f a1                	pop    %fs
  popl %es
80105926:	07                   	pop    %es
  popl %ds
80105927:	1f                   	pop    %ds
...
8010597e:	00 00 ef 
  initlock(&tickslock, "time");
80105981:	68 41 79 10 80       	push   $0x80107941
...
801059bf:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059c3:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801059f6:	0f 84 bc 01 00 00    	je     80105bb8 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
801059fc:	83 e8 20             	sub    $0x20,%eax
801059ff:	83 f8 1f             	cmp    $0x1f,%eax
80105a02:	77 08                	ja     80105a0c <trap+0x2c>
80105a04:	3e ff 24 85 e8 79 10 	notrack jmp *-0x7fef8618(,%eax,4)
80105a0b:	80 
    lapiceoi();
    break;
...
80105a0c:	e8 4f df ff ff       	call   80103960 <myproc>
80105a11:	8b 7b 38             	mov    0x38(%ebx),%edi
80105a14:	85 c0                	test   %eax,%eax
80105a16:	0f 84 eb 01 00 00    	je     80105c07 <trap+0x227>
80105a1c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a20:	0f 84 e1 01 00 00    	je     80105c07 <trap+0x227>
...
80105a2c:	e8 0f df ff ff       	call   80103940 <cpuid>
80105a31:	8b 73 30             	mov    0x30(%ebx),%esi
80105a34:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105a37:	8b 43 34             	mov    0x34(%ebx),%eax
80105a3a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105a3d:	e8 1e df ff ff       	call   80103960 <myproc>
80105a42:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105a45:	e8 16 df ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a4a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105a4d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105a50:	51                   	push   %ecx
80105a51:	57                   	push   %edi
80105a52:	52                   	push   %edx
80105a53:	ff 75 e4             	pushl  -0x1c(%ebp)
80105a56:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105a57:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105a5a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a5d:	56                   	push   %esi
80105a5e:	ff 70 10             	pushl  0x10(%eax)
80105a61:	68 a4 79 10 80       	push   $0x801079a4
80105a66:	e8 45 ac ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105a6b:	83 c4 20             	add    $0x20,%esp
80105a6e:	e8 ed de ff ff       	call   80103960 <myproc>
80105a73:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105a7a:	e8 e1 de ff ff       	call   80103960 <myproc>
80105a7f:	85 c0                	test   %eax,%eax
80105a81:	74 1d                	je     80105aa0 <trap+0xc0>
80105a83:	e8 d8 de ff ff       	call   80103960 <myproc>
80105a88:	8b 50 24             	mov    0x24(%eax),%edx
80105a8b:	85 d2                	test   %edx,%edx
80105a8d:	74 11                	je     80105aa0 <trap+0xc0>
80105a8f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a93:	83 e0 03             	and    $0x3,%eax
80105a96:	66 83 f8 03          	cmp    $0x3,%ax
80105a9a:	0f 84 50 01 00 00    	je     80105bf0 <trap+0x210>
    exit();
...
80105aa7:	74 0f                	je     80105ab8 <trap+0xd8>
80105aa9:	e8 b2 de ff ff       	call   80103960 <myproc>
80105aae:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105ab2:	0f 84 e8 00 00 00    	je     80105ba0 <trap+0x1c0>
...
80105ad8:	0f 84 03 01 00 00    	je     80105be1 <trap+0x201>
    exit();
}
...
80105ae5:	c3                   	ret    
    ideintr();
80105ae6:	e8 f5 c6 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105aeb:	e8 d0 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105af0:	e8 6b de ff ff       	call   80103960 <myproc>
80105af5:	85 c0                	test   %eax,%eax
80105af7:	75 8a                	jne    80105a83 <trap+0xa3>
80105af9:	eb a5                	jmp    80105aa0 <trap+0xc0>
    if(cpuid() == 0){
80105afb:	e8 40 de ff ff       	call   80103940 <cpuid>
80105b00:	85 c0                	test   %eax,%eax
80105b02:	75 e7                	jne    80105aeb <trap+0x10b>
      acquire(&tickslock);
80105b04:	83 ec 0c             	sub    $0xc,%esp
80105b07:	68 60 4c 11 80       	push   $0x80114c60
80105b0c:	e8 cf ea ff ff       	call   801045e0 <acquire>
      wakeup(&ticks);
80105b11:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105b18:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105b1f:	e8 bc e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b24:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105b2b:	e8 70 eb ff ff       	call   801046a0 <release>
80105b30:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105b33:	eb b6                	jmp    80105aeb <trap+0x10b>
    kbdintr();
80105b35:	e8 46 cc ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105b3a:	e8 81 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b3f:	e8 1c de ff ff       	call   80103960 <myproc>
80105b44:	85 c0                	test   %eax,%eax
80105b46:	0f 85 37 ff ff ff    	jne    80105a83 <trap+0xa3>
80105b4c:	e9 4f ff ff ff       	jmp    80105aa0 <trap+0xc0>
    uartintr();
80105b51:	e8 4a 02 00 00       	call   80105da0 <uartintr>
    lapiceoi();
80105b56:	e8 65 cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b5b:	e8 00 de ff ff       	call   80103960 <myproc>
80105b60:	85 c0                	test   %eax,%eax
80105b62:	0f 85 1b ff ff ff    	jne    80105a83 <trap+0xa3>
80105b68:	e9 33 ff ff ff       	jmp    80105aa0 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b6d:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b70:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105b74:	e8 c7 dd ff ff       	call   80103940 <cpuid>
80105b79:	57                   	push   %edi
80105b7a:	56                   	push   %esi
80105b7b:	50                   	push   %eax
80105b7c:	68 4c 79 10 80       	push   $0x8010794c
80105b81:	e8 2a ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105b86:	e8 35 cd ff ff       	call   801028c0 <lapiceoi>
    break;
80105b8b:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b8e:	e8 cd dd ff ff       	call   80103960 <myproc>
80105b93:	85 c0                	test   %eax,%eax
80105b95:	0f 85 e8 fe ff ff    	jne    80105a83 <trap+0xa3>
80105b9b:	e9 00 ff ff ff       	jmp    80105aa0 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105ba0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ba4:	0f 85 0e ff ff ff    	jne    80105ab8 <trap+0xd8>
    yield();
80105baa:	e8 21 e3 ff ff       	call   80103ed0 <yield>
80105baf:	e9 04 ff ff ff       	jmp    80105ab8 <trap+0xd8>
80105bb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105bb8:	e8 a3 dd ff ff       	call   80103960 <myproc>
...
80105bc9:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105bcc:	e8 ef ee ff ff       	call   80104ac0 <syscall>
    if(myproc()->killed)
80105bd1:	e8 8a dd ff ff       	call   80103960 <myproc>
80105bd6:	8b 48 24             	mov    0x24(%eax),%ecx
80105bd9:	85 c9                	test   %ecx,%ecx
80105bdb:	0f 84 fd fe ff ff    	je     80105ade <trap+0xfe>
}
...
80105c18:	68 70 79 10 80       	push   $0x80107970
80105c1d:	e8 8e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c22:	83 c4 14             	add    $0x14,%esp
80105c25:	68 46 79 10 80       	push   $0x80107946
80105c2a:	e8 61 a7 ff ff       	call   80100390 <panic>
80105c2f:	90                   	nop
...
80105c85:	e8 56 cc ff ff       	call   801028e0 <microdelay>
...
80105d23:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d28:	bb 68 7a 10 80       	mov    $0x80107a68,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d2d:	6a 00                	push   $0x0
80105d2f:	6a 04                	push   $0x4
80105d31:	e8 fa c6 ff ff       	call   80102430 <ioapicenable>
...
80105dbb:	6a 00                	push   $0x0
  jmp alltraps
80105dbd:	e9 47 fb ff ff       	jmp    80105909 <alltraps>
...
80105dc4:	6a 01                	push   $0x1
  jmp alltraps
80105dc6:	e9 3e fb ff ff       	jmp    80105909 <alltraps>
...
80105dcd:	6a 02                	push   $0x2
  jmp alltraps
80105dcf:	e9 35 fb ff ff       	jmp    80105909 <alltraps>
...
80105dd6:	6a 03                	push   $0x3
  jmp alltraps
80105dd8:	e9 2c fb ff ff       	jmp    80105909 <alltraps>
...
80105ddf:	6a 04                	push   $0x4
  jmp alltraps
80105de1:	e9 23 fb ff ff       	jmp    80105909 <alltraps>
...
80105de8:	6a 05                	push   $0x5
  jmp alltraps
80105dea:	e9 1a fb ff ff       	jmp    80105909 <alltraps>
...
80105df1:	6a 06                	push   $0x6
  jmp alltraps
80105df3:	e9 11 fb ff ff       	jmp    80105909 <alltraps>
...
80105dfa:	6a 07                	push   $0x7
  jmp alltraps
80105dfc:	e9 08 fb ff ff       	jmp    80105909 <alltraps>
...
80105e01:	6a 08                	push   $0x8
  jmp alltraps
80105e03:	e9 01 fb ff ff       	jmp    80105909 <alltraps>
...
80105e0a:	6a 09                	push   $0x9
  jmp alltraps
80105e0c:	e9 f8 fa ff ff       	jmp    80105909 <alltraps>
...
80105e11:	6a 0a                	push   $0xa
  jmp alltraps
80105e13:	e9 f1 fa ff ff       	jmp    80105909 <alltraps>
...
80105e18:	6a 0b                	push   $0xb
  jmp alltraps
80105e1a:	e9 ea fa ff ff       	jmp    80105909 <alltraps>
...
80105e1f:	6a 0c                	push   $0xc
  jmp alltraps
80105e21:	e9 e3 fa ff ff       	jmp    80105909 <alltraps>
...
80105e26:	6a 0d                	push   $0xd
  jmp alltraps
80105e28:	e9 dc fa ff ff       	jmp    80105909 <alltraps>
...
80105e2d:	6a 0e                	push   $0xe
  jmp alltraps
80105e2f:	e9 d5 fa ff ff       	jmp    80105909 <alltraps>
...
80105e36:	6a 0f                	push   $0xf
  jmp alltraps
80105e38:	e9 cc fa ff ff       	jmp    80105909 <alltraps>
...
80105e3f:	6a 10                	push   $0x10
  jmp alltraps
80105e41:	e9 c3 fa ff ff       	jmp    80105909 <alltraps>
...
80105e46:	6a 11                	push   $0x11
  jmp alltraps
80105e48:	e9 bc fa ff ff       	jmp    80105909 <alltraps>
...
80105e4f:	6a 12                	push   $0x12
  jmp alltraps
80105e51:	e9 b3 fa ff ff       	jmp    80105909 <alltraps>
...
80105e58:	6a 13                	push   $0x13
  jmp alltraps
80105e5a:	e9 aa fa ff ff       	jmp    80105909 <alltraps>
...
80105e61:	6a 14                	push   $0x14
  jmp alltraps
80105e63:	e9 a1 fa ff ff       	jmp    80105909 <alltraps>
...
80105e6a:	6a 15                	push   $0x15
  jmp alltraps
80105e6c:	e9 98 fa ff ff       	jmp    80105909 <alltraps>
...
80105e73:	6a 16                	push   $0x16
  jmp alltraps
80105e75:	e9 8f fa ff ff       	jmp    80105909 <alltraps>
...
80105e7c:	6a 17                	push   $0x17
  jmp alltraps
80105e7e:	e9 86 fa ff ff       	jmp    80105909 <alltraps>
...
80105e85:	6a 18                	push   $0x18
  jmp alltraps
80105e87:	e9 7d fa ff ff       	jmp    80105909 <alltraps>
...
80105e8e:	6a 19                	push   $0x19
  jmp alltraps
80105e90:	e9 74 fa ff ff       	jmp    80105909 <alltraps>
...
80105e97:	6a 1a                	push   $0x1a
  jmp alltraps
80105e99:	e9 6b fa ff ff       	jmp    80105909 <alltraps>
...
80105ea0:	6a 1b                	push   $0x1b
  jmp alltraps
80105ea2:	e9 62 fa ff ff       	jmp    80105909 <alltraps>
...
80105ea9:	6a 1c                	push   $0x1c
  jmp alltraps
80105eab:	e9 59 fa ff ff       	jmp    80105909 <alltraps>
...
80105eb2:	6a 1d                	push   $0x1d
  jmp alltraps
80105eb4:	e9 50 fa ff ff       	jmp    80105909 <alltraps>
...
80105ebb:	6a 1e                	push   $0x1e
  jmp alltraps
80105ebd:	e9 47 fa ff ff       	jmp    80105909 <alltraps>
...
80105ec4:	6a 1f                	push   $0x1f
  jmp alltraps
80105ec6:	e9 3e fa ff ff       	jmp    80105909 <alltraps>
...
80105ecd:	6a 20                	push   $0x20
  jmp alltraps
80105ecf:	e9 35 fa ff ff       	jmp    80105909 <alltraps>
...
80105ed6:	6a 21                	push   $0x21
  jmp alltraps
80105ed8:	e9 2c fa ff ff       	jmp    80105909 <alltraps>
...
80105edf:	6a 22                	push   $0x22
  jmp alltraps
80105ee1:	e9 23 fa ff ff       	jmp    80105909 <alltraps>
...
80105ee8:	6a 23                	push   $0x23
  jmp alltraps
80105eea:	e9 1a fa ff ff       	jmp    80105909 <alltraps>
...
80105ef1:	6a 24                	push   $0x24
  jmp alltraps
80105ef3:	e9 11 fa ff ff       	jmp    80105909 <alltraps>
...
80105efa:	6a 25                	push   $0x25
  jmp alltraps
80105efc:	e9 08 fa ff ff       	jmp    80105909 <alltraps>
...
80105f03:	6a 26                	push   $0x26
  jmp alltraps
80105f05:	e9 ff f9 ff ff       	jmp    80105909 <alltraps>
...
80105f0c:	6a 27                	push   $0x27
  jmp alltraps
80105f0e:	e9 f6 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f15:	6a 28                	push   $0x28
  jmp alltraps
80105f17:	e9 ed f9 ff ff       	jmp    80105909 <alltraps>
...
80105f1e:	6a 29                	push   $0x29
  jmp alltraps
80105f20:	e9 e4 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f27:	6a 2a                	push   $0x2a
  jmp alltraps
80105f29:	e9 db f9 ff ff       	jmp    80105909 <alltraps>
...
80105f30:	6a 2b                	push   $0x2b
  jmp alltraps
80105f32:	e9 d2 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f39:	6a 2c                	push   $0x2c
  jmp alltraps
80105f3b:	e9 c9 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f42:	6a 2d                	push   $0x2d
  jmp alltraps
80105f44:	e9 c0 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f4b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f4d:	e9 b7 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f54:	6a 2f                	push   $0x2f
  jmp alltraps
80105f56:	e9 ae f9 ff ff       	jmp    80105909 <alltraps>
...
80105f5d:	6a 30                	push   $0x30
  jmp alltraps
80105f5f:	e9 a5 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f66:	6a 31                	push   $0x31
  jmp alltraps
80105f68:	e9 9c f9 ff ff       	jmp    80105909 <alltraps>
...
80105f6f:	6a 32                	push   $0x32
  jmp alltraps
80105f71:	e9 93 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f78:	6a 33                	push   $0x33
  jmp alltraps
80105f7a:	e9 8a f9 ff ff       	jmp    80105909 <alltraps>
...
80105f81:	6a 34                	push   $0x34
  jmp alltraps
80105f83:	e9 81 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f8a:	6a 35                	push   $0x35
  jmp alltraps
80105f8c:	e9 78 f9 ff ff       	jmp    80105909 <alltraps>
...
80105f93:	6a 36                	push   $0x36
  jmp alltraps
80105f95:	e9 6f f9 ff ff       	jmp    80105909 <alltraps>
...
80105f9c:	6a 37                	push   $0x37
  jmp alltraps
80105f9e:	e9 66 f9 ff ff       	jmp    80105909 <alltraps>
...
80105fa5:	6a 38                	push   $0x38
  jmp alltraps
80105fa7:	e9 5d f9 ff ff       	jmp    80105909 <alltraps>
...
80105fae:	6a 39                	push   $0x39
  jmp alltraps
80105fb0:	e9 54 f9 ff ff       	jmp    80105909 <alltraps>
...
80105fb7:	6a 3a                	push   $0x3a
  jmp alltraps
80105fb9:	e9 4b f9 ff ff       	jmp    80105909 <alltraps>
...
80105fc0:	6a 3b                	push   $0x3b
  jmp alltraps
80105fc2:	e9 42 f9 ff ff       	jmp    80105909 <alltraps>
...
80105fc9:	6a 3c                	push   $0x3c
  jmp alltraps
80105fcb:	e9 39 f9 ff ff       	jmp    80105909 <alltraps>
...
80105fd2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fd4:	e9 30 f9 ff ff       	jmp    80105909 <alltraps>
...
80105fdb:	6a 3e                	push   $0x3e
  jmp alltraps
80105fdd:	e9 27 f9 ff ff       	jmp    80105909 <alltraps>
...
80105fe4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fe6:	e9 1e f9 ff ff       	jmp    80105909 <alltraps>
...
80105fed:	6a 40                	push   $0x40
  jmp alltraps
80105fef:	e9 15 f9 ff ff       	jmp    80105909 <alltraps>
...
80105ff6:	6a 41                	push   $0x41
  jmp alltraps
80105ff8:	e9 0c f9 ff ff       	jmp    80105909 <alltraps>
...
80105fff:	6a 42                	push   $0x42
  jmp alltraps
80106001:	e9 03 f9 ff ff       	jmp    80105909 <alltraps>
...
80106008:	6a 43                	push   $0x43
  jmp alltraps
8010600a:	e9 fa f8 ff ff       	jmp    80105909 <alltraps>
...
80106011:	6a 44                	push   $0x44
  jmp alltraps
80106013:	e9 f1 f8 ff ff       	jmp    80105909 <alltraps>
...
8010601a:	6a 45                	push   $0x45
  jmp alltraps
8010601c:	e9 e8 f8 ff ff       	jmp    80105909 <alltraps>
...
80106023:	6a 46                	push   $0x46
  jmp alltraps
80106025:	e9 df f8 ff ff       	jmp    80105909 <alltraps>
...
8010602c:	6a 47                	push   $0x47
  jmp alltraps
8010602e:	e9 d6 f8 ff ff       	jmp    80105909 <alltraps>
...
80106035:	6a 48                	push   $0x48
  jmp alltraps
80106037:	e9 cd f8 ff ff       	jmp    80105909 <alltraps>
...
8010603e:	6a 49                	push   $0x49
  jmp alltraps
80106040:	e9 c4 f8 ff ff       	jmp    80105909 <alltraps>
...
80106047:	6a 4a                	push   $0x4a
  jmp alltraps
80106049:	e9 bb f8 ff ff       	jmp    80105909 <alltraps>
...
80106050:	6a 4b                	push   $0x4b
  jmp alltraps
80106052:	e9 b2 f8 ff ff       	jmp    80105909 <alltraps>
...
80106059:	6a 4c                	push   $0x4c
  jmp alltraps
8010605b:	e9 a9 f8 ff ff       	jmp    80105909 <alltraps>
...
80106062:	6a 4d                	push   $0x4d
  jmp alltraps
80106064:	e9 a0 f8 ff ff       	jmp    80105909 <alltraps>
...
8010606b:	6a 4e                	push   $0x4e
  jmp alltraps
8010606d:	e9 97 f8 ff ff       	jmp    80105909 <alltraps>
...
80106074:	6a 4f                	push   $0x4f
  jmp alltraps
80106076:	e9 8e f8 ff ff       	jmp    80105909 <alltraps>
...
8010607d:	6a 50                	push   $0x50
  jmp alltraps
8010607f:	e9 85 f8 ff ff       	jmp    80105909 <alltraps>
...
80106086:	6a 51                	push   $0x51
  jmp alltraps
80106088:	e9 7c f8 ff ff       	jmp    80105909 <alltraps>
...
8010608f:	6a 52                	push   $0x52
  jmp alltraps
80106091:	e9 73 f8 ff ff       	jmp    80105909 <alltraps>
...
80106098:	6a 53                	push   $0x53
  jmp alltraps
8010609a:	e9 6a f8 ff ff       	jmp    80105909 <alltraps>
...
801060a1:	6a 54                	push   $0x54
  jmp alltraps
801060a3:	e9 61 f8 ff ff       	jmp    80105909 <alltraps>
...
801060aa:	6a 55                	push   $0x55
  jmp alltraps
801060ac:	e9 58 f8 ff ff       	jmp    80105909 <alltraps>
...
801060b3:	6a 56                	push   $0x56
  jmp alltraps
801060b5:	e9 4f f8 ff ff       	jmp    80105909 <alltraps>
...
801060bc:	6a 57                	push   $0x57
  jmp alltraps
801060be:	e9 46 f8 ff ff       	jmp    80105909 <alltraps>
...
801060c5:	6a 58                	push   $0x58
  jmp alltraps
801060c7:	e9 3d f8 ff ff       	jmp    80105909 <alltraps>
...
801060ce:	6a 59                	push   $0x59
  jmp alltraps
801060d0:	e9 34 f8 ff ff       	jmp    80105909 <alltraps>
...
801060d7:	6a 5a                	push   $0x5a
  jmp alltraps
801060d9:	e9 2b f8 ff ff       	jmp    80105909 <alltraps>
...
801060e0:	6a 5b                	push   $0x5b
  jmp alltraps
801060e2:	e9 22 f8 ff ff       	jmp    80105909 <alltraps>
...
801060e9:	6a 5c                	push   $0x5c
  jmp alltraps
801060eb:	e9 19 f8 ff ff       	jmp    80105909 <alltraps>
...
801060f2:	6a 5d                	push   $0x5d
  jmp alltraps
801060f4:	e9 10 f8 ff ff       	jmp    80105909 <alltraps>
...
801060fb:	6a 5e                	push   $0x5e
  jmp alltraps
801060fd:	e9 07 f8 ff ff       	jmp    80105909 <alltraps>
...
80106104:	6a 5f                	push   $0x5f
  jmp alltraps
80106106:	e9 fe f7 ff ff       	jmp    80105909 <alltraps>
...
8010610d:	6a 60                	push   $0x60
  jmp alltraps
8010610f:	e9 f5 f7 ff ff       	jmp    80105909 <alltraps>
...
80106116:	6a 61                	push   $0x61
  jmp alltraps
80106118:	e9 ec f7 ff ff       	jmp    80105909 <alltraps>
...
8010611f:	6a 62                	push   $0x62
  jmp alltraps
80106121:	e9 e3 f7 ff ff       	jmp    80105909 <alltraps>
...
80106128:	6a 63                	push   $0x63
  jmp alltraps
8010612a:	e9 da f7 ff ff       	jmp    80105909 <alltraps>
...
80106131:	6a 64                	push   $0x64
  jmp alltraps
80106133:	e9 d1 f7 ff ff       	jmp    80105909 <alltraps>
...
8010613a:	6a 65                	push   $0x65
  jmp alltraps
8010613c:	e9 c8 f7 ff ff       	jmp    80105909 <alltraps>
...
80106143:	6a 66                	push   $0x66
  jmp alltraps
80106145:	e9 bf f7 ff ff       	jmp    80105909 <alltraps>
...
8010614c:	6a 67                	push   $0x67
  jmp alltraps
8010614e:	e9 b6 f7 ff ff       	jmp    80105909 <alltraps>
...
80106155:	6a 68                	push   $0x68
  jmp alltraps
80106157:	e9 ad f7 ff ff       	jmp    80105909 <alltraps>
...
8010615e:	6a 69                	push   $0x69
  jmp alltraps
80106160:	e9 a4 f7 ff ff       	jmp    80105909 <alltraps>
...
80106167:	6a 6a                	push   $0x6a
  jmp alltraps
80106169:	e9 9b f7 ff ff       	jmp    80105909 <alltraps>
...
80106170:	6a 6b                	push   $0x6b
  jmp alltraps
80106172:	e9 92 f7 ff ff       	jmp    80105909 <alltraps>
...
80106179:	6a 6c                	push   $0x6c
  jmp alltraps
8010617b:	e9 89 f7 ff ff       	jmp    80105909 <alltraps>
...
80106182:	6a 6d                	push   $0x6d
  jmp alltraps
80106184:	e9 80 f7 ff ff       	jmp    80105909 <alltraps>
...
8010618b:	6a 6e                	push   $0x6e
  jmp alltraps
8010618d:	e9 77 f7 ff ff       	jmp    80105909 <alltraps>
...
80106194:	6a 6f                	push   $0x6f
  jmp alltraps
80106196:	e9 6e f7 ff ff       	jmp    80105909 <alltraps>
...
8010619d:	6a 70                	push   $0x70
  jmp alltraps
8010619f:	e9 65 f7 ff ff       	jmp    80105909 <alltraps>
...
801061a6:	6a 71                	push   $0x71
  jmp alltraps
801061a8:	e9 5c f7 ff ff       	jmp    80105909 <alltraps>
...
801061af:	6a 72                	push   $0x72
  jmp alltraps
801061b1:	e9 53 f7 ff ff       	jmp    80105909 <alltraps>
...
801061b8:	6a 73                	push   $0x73
  jmp alltraps
801061ba:	e9 4a f7 ff ff       	jmp    80105909 <alltraps>
...
801061c1:	6a 74                	push   $0x74
  jmp alltraps
801061c3:	e9 41 f7 ff ff       	jmp    80105909 <alltraps>
...
801061ca:	6a 75                	push   $0x75
  jmp alltraps
801061cc:	e9 38 f7 ff ff       	jmp    80105909 <alltraps>
...
801061d3:	6a 76                	push   $0x76
  jmp alltraps
801061d5:	e9 2f f7 ff ff       	jmp    80105909 <alltraps>
...
801061dc:	6a 77                	push   $0x77
  jmp alltraps
801061de:	e9 26 f7 ff ff       	jmp    80105909 <alltraps>
...
801061e5:	6a 78                	push   $0x78
  jmp alltraps
801061e7:	e9 1d f7 ff ff       	jmp    80105909 <alltraps>
...
801061ee:	6a 79                	push   $0x79
  jmp alltraps
801061f0:	e9 14 f7 ff ff       	jmp    80105909 <alltraps>
...
801061f7:	6a 7a                	push   $0x7a
  jmp alltraps
801061f9:	e9 0b f7 ff ff       	jmp    80105909 <alltraps>
...
80106200:	6a 7b                	push   $0x7b
  jmp alltraps
80106202:	e9 02 f7 ff ff       	jmp    80105909 <alltraps>
...
80106209:	6a 7c                	push   $0x7c
  jmp alltraps
8010620b:	e9 f9 f6 ff ff       	jmp    80105909 <alltraps>
...
80106212:	6a 7d                	push   $0x7d
  jmp alltraps
80106214:	e9 f0 f6 ff ff       	jmp    80105909 <alltraps>
...
8010621b:	6a 7e                	push   $0x7e
  jmp alltraps
8010621d:	e9 e7 f6 ff ff       	jmp    80105909 <alltraps>
...
80106224:	6a 7f                	push   $0x7f
  jmp alltraps
80106226:	e9 de f6 ff ff       	jmp    80105909 <alltraps>
...
8010622d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106232:	e9 d2 f6 ff ff       	jmp    80105909 <alltraps>
...
80106239:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010623e:	e9 c6 f6 ff ff       	jmp    80105909 <alltraps>
...
80106245:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010624a:	e9 ba f6 ff ff       	jmp    80105909 <alltraps>
...
80106251:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106256:	e9 ae f6 ff ff       	jmp    80105909 <alltraps>
...
8010625d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106262:	e9 a2 f6 ff ff       	jmp    80105909 <alltraps>
...
80106269:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010626e:	e9 96 f6 ff ff       	jmp    80105909 <alltraps>
...
80106275:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010627a:	e9 8a f6 ff ff       	jmp    80105909 <alltraps>
...
80106281:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106286:	e9 7e f6 ff ff       	jmp    80105909 <alltraps>
...
8010628d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106292:	e9 72 f6 ff ff       	jmp    80105909 <alltraps>
...
80106299:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010629e:	e9 66 f6 ff ff       	jmp    80105909 <alltraps>
...
801062a5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062aa:	e9 5a f6 ff ff       	jmp    80105909 <alltraps>
...
801062b1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062b6:	e9 4e f6 ff ff       	jmp    80105909 <alltraps>
...
801062bd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062c2:	e9 42 f6 ff ff       	jmp    80105909 <alltraps>
...
801062c9:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ce:	e9 36 f6 ff ff       	jmp    80105909 <alltraps>
...
801062d5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062da:	e9 2a f6 ff ff       	jmp    80105909 <alltraps>
...
801062e1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062e6:	e9 1e f6 ff ff       	jmp    80105909 <alltraps>
...
801062ed:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062f2:	e9 12 f6 ff ff       	jmp    80105909 <alltraps>
...
801062f9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062fe:	e9 06 f6 ff ff       	jmp    80105909 <alltraps>
...
80106305:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010630a:	e9 fa f5 ff ff       	jmp    80105909 <alltraps>
...
80106311:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106316:	e9 ee f5 ff ff       	jmp    80105909 <alltraps>
...
8010631d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106322:	e9 e2 f5 ff ff       	jmp    80105909 <alltraps>
...
80106329:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010632e:	e9 d6 f5 ff ff       	jmp    80105909 <alltraps>
...
80106335:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010633a:	e9 ca f5 ff ff       	jmp    80105909 <alltraps>
...
80106341:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106346:	e9 be f5 ff ff       	jmp    80105909 <alltraps>
...
8010634d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106352:	e9 b2 f5 ff ff       	jmp    80105909 <alltraps>
...
80106359:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010635e:	e9 a6 f5 ff ff       	jmp    80105909 <alltraps>
...
80106365:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010636a:	e9 9a f5 ff ff       	jmp    80105909 <alltraps>
...
80106371:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106376:	e9 8e f5 ff ff       	jmp    80105909 <alltraps>
...
8010637d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106382:	e9 82 f5 ff ff       	jmp    80105909 <alltraps>
...
80106389:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010638e:	e9 76 f5 ff ff       	jmp    80105909 <alltraps>
...
80106395:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010639a:	e9 6a f5 ff ff       	jmp    80105909 <alltraps>
...
801063a1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063a6:	e9 5e f5 ff ff       	jmp    80105909 <alltraps>
...
801063ad:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063b2:	e9 52 f5 ff ff       	jmp    80105909 <alltraps>
...
801063b9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063be:	e9 46 f5 ff ff       	jmp    80105909 <alltraps>
...
801063c5:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063ca:	e9 3a f5 ff ff       	jmp    80105909 <alltraps>
...
801063d1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063d6:	e9 2e f5 ff ff       	jmp    80105909 <alltraps>
...
801063dd:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063e2:	e9 22 f5 ff ff       	jmp    80105909 <alltraps>
...
801063e9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ee:	e9 16 f5 ff ff       	jmp    80105909 <alltraps>
...
801063f5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063fa:	e9 0a f5 ff ff       	jmp    80105909 <alltraps>
...
80106401:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106406:	e9 fe f4 ff ff       	jmp    80105909 <alltraps>
...
8010640d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106412:	e9 f2 f4 ff ff       	jmp    80105909 <alltraps>
...
80106419:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010641e:	e9 e6 f4 ff ff       	jmp    80105909 <alltraps>
...
80106425:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010642a:	e9 da f4 ff ff       	jmp    80105909 <alltraps>
...
80106431:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106436:	e9 ce f4 ff ff       	jmp    80105909 <alltraps>
...
8010643d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106442:	e9 c2 f4 ff ff       	jmp    80105909 <alltraps>
...
80106449:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010644e:	e9 b6 f4 ff ff       	jmp    80105909 <alltraps>
...
80106455:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010645a:	e9 aa f4 ff ff       	jmp    80105909 <alltraps>
...
80106461:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106466:	e9 9e f4 ff ff       	jmp    80105909 <alltraps>
...
8010646d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106472:	e9 92 f4 ff ff       	jmp    80105909 <alltraps>
...
80106479:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010647e:	e9 86 f4 ff ff       	jmp    80105909 <alltraps>
...
80106485:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010648a:	e9 7a f4 ff ff       	jmp    80105909 <alltraps>
...
80106491:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106496:	e9 6e f4 ff ff       	jmp    80105909 <alltraps>
...
8010649d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064a2:	e9 62 f4 ff ff       	jmp    80105909 <alltraps>
...
801064a9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ae:	e9 56 f4 ff ff       	jmp    80105909 <alltraps>
...
801064b5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064ba:	e9 4a f4 ff ff       	jmp    80105909 <alltraps>
...
801064c1:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064c6:	e9 3e f4 ff ff       	jmp    80105909 <alltraps>
...
801064cd:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064d2:	e9 32 f4 ff ff       	jmp    80105909 <alltraps>
...
801064d9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064de:	e9 26 f4 ff ff       	jmp    80105909 <alltraps>
...
801064e5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064ea:	e9 1a f4 ff ff       	jmp    80105909 <alltraps>
...
801064f1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064f6:	e9 0e f4 ff ff       	jmp    80105909 <alltraps>
...
801064fd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106502:	e9 02 f4 ff ff       	jmp    80105909 <alltraps>
...
80106509:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010650e:	e9 f6 f3 ff ff       	jmp    80105909 <alltraps>
...
80106515:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010651a:	e9 ea f3 ff ff       	jmp    80105909 <alltraps>
...
80106521:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106526:	e9 de f3 ff ff       	jmp    80105909 <alltraps>
...
8010652d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106532:	e9 d2 f3 ff ff       	jmp    80105909 <alltraps>
...
80106539:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010653e:	e9 c6 f3 ff ff       	jmp    80105909 <alltraps>
...
80106545:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010654a:	e9 ba f3 ff ff       	jmp    80105909 <alltraps>
...
80106551:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106556:	e9 ae f3 ff ff       	jmp    80105909 <alltraps>
...
8010655d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106562:	e9 a2 f3 ff ff       	jmp    80105909 <alltraps>
...
80106569:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010656e:	e9 96 f3 ff ff       	jmp    80105909 <alltraps>
...
80106575:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010657a:	e9 8a f3 ff ff       	jmp    80105909 <alltraps>
...
80106581:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106586:	e9 7e f3 ff ff       	jmp    80105909 <alltraps>
...
8010658d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106592:	e9 72 f3 ff ff       	jmp    80105909 <alltraps>
...
80106599:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010659e:	e9 66 f3 ff ff       	jmp    80105909 <alltraps>
...
801065a5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065aa:	e9 5a f3 ff ff       	jmp    80105909 <alltraps>
...
801065b1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065b6:	e9 4e f3 ff ff       	jmp    80105909 <alltraps>
...
801065bd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065c2:	e9 42 f3 ff ff       	jmp    80105909 <alltraps>
...
801065c9:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ce:	e9 36 f3 ff ff       	jmp    80105909 <alltraps>
...
801065d5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065da:	e9 2a f3 ff ff       	jmp    80105909 <alltraps>
...
801065e1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065e6:	e9 1e f3 ff ff       	jmp    80105909 <alltraps>
...
801065ed:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065f2:	e9 12 f3 ff ff       	jmp    80105909 <alltraps>
...
801065f9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065fe:	e9 06 f3 ff ff       	jmp    80105909 <alltraps>
...
80106605:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
8010660a:	e9 fa f2 ff ff       	jmp    80105909 <alltraps>
...
80106611:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106616:	e9 ee f2 ff ff       	jmp    80105909 <alltraps>
...
8010661d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106622:	e9 e2 f2 ff ff       	jmp    80105909 <alltraps>
...
80106629:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010662e:	e9 d6 f2 ff ff       	jmp    80105909 <alltraps>
...
80106635:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
8010663a:	e9 ca f2 ff ff       	jmp    80105909 <alltraps>
...
80106641:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106646:	e9 be f2 ff ff       	jmp    80105909 <alltraps>
...
8010664d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106652:	e9 b2 f2 ff ff       	jmp    80105909 <alltraps>
...
80106659:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010665e:	e9 a6 f2 ff ff       	jmp    80105909 <alltraps>
...
80106665:	68 da 00 00 00       	push   $0xda
  jmp alltraps
8010666a:	e9 9a f2 ff ff       	jmp    80105909 <alltraps>
...
80106671:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106676:	e9 8e f2 ff ff       	jmp    80105909 <alltraps>
...
8010667d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106682:	e9 82 f2 ff ff       	jmp    80105909 <alltraps>
...
80106689:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010668e:	e9 76 f2 ff ff       	jmp    80105909 <alltraps>
...
80106695:	68 de 00 00 00       	push   $0xde
  jmp alltraps
8010669a:	e9 6a f2 ff ff       	jmp    80105909 <alltraps>
...
801066a1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066a6:	e9 5e f2 ff ff       	jmp    80105909 <alltraps>
...
801066ad:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066b2:	e9 52 f2 ff ff       	jmp    80105909 <alltraps>
...
801066b9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066be:	e9 46 f2 ff ff       	jmp    80105909 <alltraps>
...
801066c5:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066ca:	e9 3a f2 ff ff       	jmp    80105909 <alltraps>
...
801066d1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066d6:	e9 2e f2 ff ff       	jmp    80105909 <alltraps>
...
801066dd:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066e2:	e9 22 f2 ff ff       	jmp    80105909 <alltraps>
...
801066e9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ee:	e9 16 f2 ff ff       	jmp    80105909 <alltraps>
...
801066f5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066fa:	e9 0a f2 ff ff       	jmp    80105909 <alltraps>
...
80106701:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106706:	e9 fe f1 ff ff       	jmp    80105909 <alltraps>
...
8010670d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106712:	e9 f2 f1 ff ff       	jmp    80105909 <alltraps>
...
80106719:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010671e:	e9 e6 f1 ff ff       	jmp    80105909 <alltraps>
...
80106725:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
8010672a:	e9 da f1 ff ff       	jmp    80105909 <alltraps>
...
80106731:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106736:	e9 ce f1 ff ff       	jmp    80105909 <alltraps>
...
8010673d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106742:	e9 c2 f1 ff ff       	jmp    80105909 <alltraps>
...
80106749:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010674e:	e9 b6 f1 ff ff       	jmp    80105909 <alltraps>
...
80106755:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
8010675a:	e9 aa f1 ff ff       	jmp    80105909 <alltraps>
...
80106761:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106766:	e9 9e f1 ff ff       	jmp    80105909 <alltraps>
...
8010676d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106772:	e9 92 f1 ff ff       	jmp    80105909 <alltraps>
...
80106779:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010677e:	e9 86 f1 ff ff       	jmp    80105909 <alltraps>
...
80106785:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
8010678a:	e9 7a f1 ff ff       	jmp    80105909 <alltraps>
...
80106791:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106796:	e9 6e f1 ff ff       	jmp    80105909 <alltraps>
...
8010679d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067a2:	e9 62 f1 ff ff       	jmp    80105909 <alltraps>
...
801067a9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ae:	e9 56 f1 ff ff       	jmp    80105909 <alltraps>
...
801067b5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067ba:	e9 4a f1 ff ff       	jmp    80105909 <alltraps>
...
801067c1:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067c6:	e9 3e f1 ff ff       	jmp    80105909 <alltraps>
...
801067cd:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067d2:	e9 32 f1 ff ff       	jmp    80105909 <alltraps>
...
801067d9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067de:	e9 26 f1 ff ff       	jmp    80105909 <alltraps>
...
801067e5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067ea:	e9 1a f1 ff ff       	jmp    80105909 <alltraps>
...
801067f1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067f6:	e9 0e f1 ff ff       	jmp    80105909 <alltraps>
...
801067fd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106802:	e9 02 f1 ff ff       	jmp    80105909 <alltraps>
...
80106809:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010680e:	e9 f6 f0 ff ff       	jmp    80105909 <alltraps>
...
80106815:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
8010681a:	e9 ea f0 ff ff       	jmp    80105909 <alltraps>
...
80106821:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106826:	e9 de f0 ff ff       	jmp    80105909 <alltraps>
...
80106874:	e8 b7 bd ff ff       	call   80102630 <kalloc>
...
8010688a:	e8 61 de ff ff       	call   801046f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010692d:	68 70 7a 10 80       	push   $0x80107a70
...
801069a8:	e8 c3 ba ff ff       	call   80102470 <kfree>
      *pte = 0;
...
801069f7:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069fa:	e8 41 cf ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106a84:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106ac8:	0f 84 c2 00 00 00    	je     80106b90 <switchuvm+0xf0>
  pushcli();
80106ace:	e8 0d da ff ff       	call   801044e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106ad3:	e8 f8 cd ff ff       	call   801038d0 <mycpu>
80106ad8:	89 c3                	mov    %eax,%ebx
80106ada:	e8 f1 cd ff ff       	call   801038d0 <mycpu>
...
80106aec:	e8 df cd ff ff       	call   801038d0 <mycpu>
...
80106b35:	e8 96 cd ff ff       	call   801038d0 <mycpu>
...
80106b53:	e8 78 cd ff ff       	call   801038d0 <mycpu>
80106b58:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b5b:	e8 70 cd ff ff       	call   801038d0 <mycpu>
...
80106bcf:	77 4b                	ja     80106c1c <inituvm+0x6c>
  mem = kalloc();
80106bd1:	e8 5a ba ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106be3:	e8 08 db ff ff       	call   801046f0 <memset>
...
80106c16:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c17:	e9 74 db ff ff       	jmp    80104790 <memmove>
    panic("inituvm: more than a page");
80106c1c:	83 ec 0c             	sub    $0xc,%esp
80106c1f:	68 b5 7a 10 80       	push   $0x80107ab5
...
80106cae:	e8 ad ad ff ff       	call   80101a60 <readi>
...
80106d4b:	e8 a0 d9 ff ff       	call   801046f0 <memset>
...
80106d79:	76 48                	jbe    80106dc3 <allocuvm+0xc3>
    mem = kalloc();
80106d7b:	e8 b0 b8 ff ff       	call   80102630 <kalloc>
...
80106d89:	68 ed 7a 10 80       	push   $0x80107aed
...
80106deb:	68 05 7b 10 80       	push   $0x80107b05
...
80106e10:	e8 5b b6 ff ff       	call   80102470 <kfree>
      return 0;
...
80106f04:	e8 e7 d7 ff ff       	call   801046f0 <memset>
...
80106f6f:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fa3:	68 32 7b 10 80       	push   $0x80107b32
...
80106ff0:	e8 9b d7 ff ff       	call   80104790 <memmove>
...
80107042:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107048:	e8 e3 b5 ff ff       	call   80102630 <kalloc>
...
8010711e:	e8 6d d6 ff ff       	call   80104790 <memmove>
    len -= n;
    buf += n;
